...
insert into reward (point_system_id, type, category, title, description, icon, 
yen_per_point, price_per_unit, min_points, max_points, required_points, max_period, 
update_time, update_user) values
(2, 'discount', 'Beauty', '3,000円ホットペッパービューティーサロン割引','1回あたり100ポイントから3,000ポイントまで100ポイント単位でご利用可能です。※事前申請必要。ご利用店によって最大ポイント利用制限あり', NULL, 1, 100, 100, 3000, 3000, '回', NOW(), 'Ben'), 
...
(6, 'free product', 'Limited Ed. Goods', 'ワンピース限定グッズ','ワンピースVISAカードの場合、ここでしか手に入らないフロストアートボード（アルティメットフレーム付）と交換することができます。', NULL, N/A, N/A, 3000, NULL,  3000, '', NOW(), 'Ben'), 
...
(7, 'discount', 'Auto', 'ENEOSでガソリンを','月1万円利用で２円/ℓ割引', NULL, N/A, N/A, N/A, NULL,  >10K month @ ENEOS, '', NOW(), 'Ben'), 
(7, 'discount', 'Auto', 'ENEOSでガソリンを','月2万円利用で4円/ℓ割引', NULL, N/A, N/A, N/A, NULL,  >20K month @ ENEOS, '', NOW(), 'Ben'), 
(7, 'discount', 'Auto', 'ENEOSでガソリンを','月5万円利用で5円/ℓ割引', NULL, N/A, N/A, N/A, NULL,  >50K month @ ENEOS, '', NOW(), 'Ben'), 
(7, 'free product', 'Electronics', 'スチームクリーナー','ポイントでスチームクリーナーがもらえる！', NULL, N/A, N/A, 10000, NULL,  10000, '', NOW(), 'Ben'), 
(8, 'exchange', 'Mileage', 'ANA マイルレージに交換','1ポイント→3 ANA マイル', NULL, 0.33333333, 300, 300, NULL,  10000, '', NOW(), 'Ben'), 
...
(9, 'free product', 'Electronics', 'BOSE サウンドドックシリーズIII','ミュージックサウンドシステムをポイントでもらえる', NULL, N/A, N/A, 5000, NULL, NULL,  '', NOW(), 'Ben'), 
...
"(12, 'free product', 'Restaurants', '品川プリンスホテルディナー券','品川プリンスホテル　リュクス ダイニング ハプナ ディナー券(2時間飲み放題付き)　1名様', NULL, N/A, N/A, 5000, NULL, NULL,  '', NOW(), 'Ben'), 
...
(16, 'free product', 'Mileage', '東京→大阪片道飛行機チケット','ローシーズン限定', NULL, N/A, N/A, 7000, NULL, NULL,  '', NOW(), 'Ben'), 
(16, 'free product', 'Mileage', '東京→福岡片道飛行機チケット','ローシーズン限定', NULL, N/A, N/A, 8500, NULL, NULL,  '', NOW(), 'Ben'), 
(16, 'free product', 'Mileage', '東京→ハワイ片道飛行機チケット','ローシーズン限定', NULL, N/A, N/A, 17500, NULL, NULL,  '', NOW(), 'Ben');
*/
