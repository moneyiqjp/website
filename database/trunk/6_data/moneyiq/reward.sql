...
INSERT IGNORE INTO `reward` (`reward_id`, `point_system_id`, `reward_category_id`, `reward_type_id`, `title`, `description`, `icon`, `yen_per_point`, `price_per_unit`, `min_points`, `max_points`, `required_points`, `max_period`, `update_time`, `update_user`) VALUES
	...
	(47, 2, 15, 5, 'test', 'test', 'test', 1.000000, 1, 1, 1, 1, 'test', '2015-06-27 01:48:40', ''),
	(48, 2, 15, 5, 'test', 'test', 'test', 1.000000, 1, 1, 1, 1, 'test', '2015-06-27 01:58:19', ''),
	(49, 2, 15, 5, 'test', 'test', 'test', 1.000000, 1, 1, 1, 1, 'test', '2015-06-27 02:11:15', ''),
	(50, 2, 15, 5, 'test', 'test', 'test', 1.000000, 1, 1, 1, 1, 'test', '2015-06-27 02:12:34', '');
