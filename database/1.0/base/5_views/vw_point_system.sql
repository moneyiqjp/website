...
select point_system_id, point_system_name, points_per_yen, credit_card_id, store_id, update_time time_beg, '9999-12-31' time_end, update_user  from point_system ac
union
