...
abstract class Reward implements ActiveRecordInterface
{
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[RewardTableMap::COL_TYPE] = true;
        }
    ...
    public function setCategory($v)
    {
        ...
        if ($this->category !== $v) {
            $this->category = $v;
            $this->modifiedColumns[RewardTableMap::COL_CATEGORY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RewardTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : RewardTableMap::translateFieldName('Category', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 15; // 15 = RewardTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RewardTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }
        if ($this->isColumnModified(RewardTableMap::COL_CATEGORY)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RewardTableMap::COL_TYPE)) {
            $criteria->add(RewardTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(RewardTableMap::COL_CATEGORY)) {
            $criteria->add(RewardTableMap::COL_CATEGORY, $this->category);
        }
        if ($this->isColumnModified(RewardTableMap::COL_TITLE)) {
