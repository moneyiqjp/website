...
abstract class PointAcquisitionHistory implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PointAcquisitionHistoryTableMap';
    ...
    /**
     * Initializes internal state of Base\PointAcquisitionHistory object.
     */
    ...
    /**
     * Compares this with another <code>PointAcquisitionHistory</code> instance.  If
     * <code>obj</code> is an instance of <code>PointAcquisitionHistory</code>, delegates to
     * <code>equals(PointAcquisitionHistory)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PointAcquisitionHistory The current object, for fluid interface
     */
    ...
    public function setPointAcquisitionId($v)
    {
        ...
        if ($this->point_acquisition_id !== $v) {
            ...
            $this->modifiedColumns[PointAcquisitionHistoryTableMap::COL_POINT_ACQUISITION_ID] = true;
        }
    ...
    public function setPointAcquisitionName($v)
    {
        ...
        if ($this->point_acquisition_name !== $v) {
            ...
            $this->modifiedColumns[PointAcquisitionHistoryTableMap::COL_POINT_ACQUISITION_NAME] = true;
        }
    ...
    public function setPointsPerYen($v)
    {
        ...
        if ($this->points_per_yen !== $v) {
            ...
            $this->modifiedColumns[PointAcquisitionHistoryTableMap::COL_POINTS_PER_YEN] = true;
        }
    ...
    public function setPointSystemId($v)
    {
        ...
        if ($this->point_system_id !== $v) {
            ...
            $this->modifiedColumns[PointAcquisitionHistoryTableMap::COL_POINT_SYSTEM_ID] = true;
        }
    ...
    public function setStoreId($v)
    {
        ...
        if ($this->store_id !== $v) {
            $this->store_id = $v;
            $this->modifiedColumns[PointAcquisitionHistoryTableMap::COL_STORE_ID] = true;
        }
    ...
    public function setTimeBeg($v)
    {
        ...
        if ($this->time_beg !== null || $dt !== null) {
            if ($dt !== $this->time_beg) {
                $this->time_beg = $dt;
                $this->modifiedColumns[PointAcquisitionHistoryTableMap::COL_TIME_BEG] = true;
            }
    ...
    public function setTimeEnd($v)
    {
        ...
        if ($this->time_end !== null || $dt !== null) {
            if ($dt !== $this->time_end) {
                $this->time_end = $dt;
                $this->modifiedColumns[PointAcquisitionHistoryTableMap::COL_TIME_END] = true;
            }
        } // if either are not null
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[PointAcquisitionHistoryTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PointAcquisitionHistoryTableMap::translateFieldName('PointAcquisitionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->point_acquisition_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PointAcquisitionHistoryTableMap::translateFieldName('PointAcquisitionName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->point_acquisition_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PointAcquisitionHistoryTableMap::translateFieldName('PointsPerYen', TableMap::TYPE_PHPNAME, $indexType)];
            $this->points_per_yen = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PointAcquisitionHistoryTableMap::translateFieldName('PointSystemId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->point_system_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PointAcquisitionHistoryTableMap::translateFieldName('StoreId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->store_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PointAcquisitionHistoryTableMap::translateFieldName('TimeBeg', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->time_beg = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : PointAcquisitionHistoryTableMap::translateFieldName('TimeEnd', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->time_end = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : PointAcquisitionHistoryTableMap::translateFieldName('UpdateUser', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = PointAcquisitionHistoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PointAcquisitionHistory'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPointAcquisitionHistoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PointAcquisitionHistory::setDeleted()
     * @see PointAcquisitionHistory::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPointAcquisitionHistoryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PointAcquisitionHistoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_POINT_ACQUISITION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'point_acquisition_id';
        }
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_POINT_ACQUISITION_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'point_acquisition_name';
        }
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_POINTS_PER_YEN)) {
            $modifiedColumns[':p' . $index++]  = 'points_per_yen';
        }
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_POINT_SYSTEM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'point_system_id';
        }
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_STORE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'store_id';
        }
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_TIME_BEG)) {
            $modifiedColumns[':p' . $index++]  = 'time_beg';
        }
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_TIME_END)) {
            $modifiedColumns[':p' . $index++]  = 'time_end';
        }
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }

        $sql = sprintf(
            'INSERT INTO point_acquisition_history (%s) VALUES (%s)',
    ...
    {
        $pos = PointAcquisitionHistoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['PointAcquisitionHistory'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PointAcquisitionHistory'][$this->hashCode()] = true;
        $keys = PointAcquisitionHistoryTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PointAcquisitionHistory
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_POINT_ACQUISITION_ID)) {
            $criteria->add(PointAcquisitionHistoryTableMap::COL_POINT_ACQUISITION_ID, $this->point_acquisition_id);
        }
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_POINT_ACQUISITION_NAME)) {
            $criteria->add(PointAcquisitionHistoryTableMap::COL_POINT_ACQUISITION_NAME, $this->point_acquisition_name);
        }
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_POINTS_PER_YEN)) {
            $criteria->add(PointAcquisitionHistoryTableMap::COL_POINTS_PER_YEN, $this->points_per_yen);
        }
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_POINT_SYSTEM_ID)) {
            $criteria->add(PointAcquisitionHistoryTableMap::COL_POINT_SYSTEM_ID, $this->point_system_id);
        }
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_STORE_ID)) {
            $criteria->add(PointAcquisitionHistoryTableMap::COL_STORE_ID, $this->store_id);
        }
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_TIME_BEG)) {
            $criteria->add(PointAcquisitionHistoryTableMap::COL_TIME_BEG, $this->time_beg);
        }
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_TIME_END)) {
            $criteria->add(PointAcquisitionHistoryTableMap::COL_TIME_END, $this->time_end);
        }
        if ($this->isColumnModified(PointAcquisitionHistoryTableMap::COL_UPDATE_USER)) {
            $criteria->add(PointAcquisitionHistoryTableMap::COL_UPDATE_USER, $this->update_user);
        }
    ...
    {
        $criteria = ChildPointAcquisitionHistoryQuery::create();
        $criteria->add(PointAcquisitionHistoryTableMap::COL_POINT_ACQUISITION_ID, $this->point_acquisition_id);
        $criteria->add(PointAcquisitionHistoryTableMap::COL_TIME_BEG, $this->time_beg);
    ...
    {
        $pks = array();
        $pks[0] = $this->getPointAcquisitionId();
    ...
    {
        $this->setPointAcquisitionId($keys[0]);
    ...
    {
        return (null === $this->getPointAcquisitionId()) && (null === $this->getTimeBeg());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PointAcquisitionHistory (or compatible) type.
    ...
    {
        $copyObj->setPointAcquisitionId($this->getPointAcquisitionId());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PointAcquisitionHistory Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PointAcquisitionHistoryTableMap::DEFAULT_STRING_FORMAT);
    }
