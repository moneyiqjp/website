...
abstract class PointUse implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PointUseTableMap';
    ...
    /**
     * The value for the point_use_id field.
     * @var        int
     */
    protected $point_use_id;
    ...
    /**
     * Initializes internal state of Base\PointUse object.
     */
    ...
    /**
     * Compares this with another <code>PointUse</code> instance.  If
     * <code>obj</code> is an instance of <code>PointUse</code>, delegates to
     * <code>equals(PointUse)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PointUse The current object, for fluid interface
     */
     ...
     */
    public function setPointUseId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->point_use_id !== $v) {
            $this->point_use_id = $v;
            $this->modifiedColumns[PointUseTableMap::COL_POINT_USE_ID] = true;
        }
    ...
    public function setPointSystemId($v)
    {
        ...
        if ($this->point_system_id !== $v) {
            ...
            $this->modifiedColumns[PointUseTableMap::COL_POINT_SYSTEM_ID] = true;
        }
    ...
    public function setStoreId($v)
    {
        ...
        if ($this->store_id !== $v) {
            $this->store_id = $v;
            $this->modifiedColumns[PointUseTableMap::COL_STORE_ID] = true;
        }
    ...
    public function setYenPerPoint($v)
    {
        ...
        if ($this->yen_per_point !== $v) {
            ...
            $this->modifiedColumns[PointUseTableMap::COL_YEN_PER_POINT] = true;
        }
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            if ($dt !== $this->update_time) {
                $this->update_time = $dt;
                $this->modifiedColumns[PointUseTableMap::COL_UPDATE_TIME] = true;
            }
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[PointUseTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PointUseTableMap::translateFieldName('PointUseId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->point_use_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PointUseTableMap::translateFieldName('PointSystemId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->point_system_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PointUseTableMap::translateFieldName('StoreId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->store_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PointUseTableMap::translateFieldName('YenPerPoint', TableMap::TYPE_PHPNAME, $indexType)];
            $this->yen_per_point = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PointUseTableMap::translateFieldName('UpdateTime', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPointUseQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PointUse::setDeleted()
     * @see PointUse::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPointUseQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PointUseTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PointUseTableMap::COL_POINT_USE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'point_use_id';
        }
        if ($this->isColumnModified(PointUseTableMap::COL_POINT_SYSTEM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'point_system_id';
        }
        if ($this->isColumnModified(PointUseTableMap::COL_STORE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'store_id';
        }
        if ($this->isColumnModified(PointUseTableMap::COL_YEN_PER_POINT)) {
            $modifiedColumns[':p' . $index++]  = 'yen_per_point';
        }
        if ($this->isColumnModified(PointUseTableMap::COL_UPDATE_TIME)) {
    ...
    {
        $pos = PointUseTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PointUse'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PointUse'][$this->hashCode()] = true;
        $keys = PointUseTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getPointUseId(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setYenPerPoint($arr[$keys[3]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PointUseTableMap::COL_POINT_USE_ID)) {
            $criteria->add(PointUseTableMap::COL_POINT_USE_ID, $this->point_use_id);
        }
        if ($this->isColumnModified(PointUseTableMap::COL_POINT_SYSTEM_ID)) {
            $criteria->add(PointUseTableMap::COL_POINT_SYSTEM_ID, $this->point_system_id);
        }
        if ($this->isColumnModified(PointUseTableMap::COL_STORE_ID)) {
            $criteria->add(PointUseTableMap::COL_STORE_ID, $this->store_id);
        }
        if ($this->isColumnModified(PointUseTableMap::COL_YEN_PER_POINT)) {
            $criteria->add(PointUseTableMap::COL_YEN_PER_POINT, $this->yen_per_point);
        }
        if ($this->isColumnModified(PointUseTableMap::COL_UPDATE_TIME)) {
            $criteria->add(PointUseTableMap::COL_UPDATE_TIME, $this->update_time);
        }
        if ($this->isColumnModified(PointUseTableMap::COL_UPDATE_USER)) {
    ...
    {
        $criteria = ChildPointUseQuery::create();
        $criteria->add(PointUseTableMap::COL_POINT_USE_ID, $this->point_use_id);
    ...
    {
        $validPk = null !== $this->getPointUseId();
    ...
    /**
     * Generic method to set the primary key (point_use_id column).
     *
    ...
    {
        return null === $this->getPointUseId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PointUse (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PointUse Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPointSystem(ConnectionInterface $con = null)
    {
        if ($this->aPointSystem === null && ($this->point_system_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPointSystem->addPointUses($this);
             */
        }
    ...
    {
        if (null !== $this->aPointSystem) {
            $this->aPointSystem->removePointUse($this);
        }
        if (null !== $this->aStore) {
            $this->aStore->removePointUse($this);
        }
        $this->point_use_id = null;
    ...
    {
        return (string) $this->exportTo(PointUseTableMap::DEFAULT_STRING_FORMAT);
    }
