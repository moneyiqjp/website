...
abstract class Region implements ActiveRecordInterface
{
    ...
    public function setRegionId($v)
    {
        ...
        if ($this->region_id !== $v) {
            $this->region_id = $v;
            $this->modifiedColumns[RegionTableMap::COL_REGION_ID] = true;
        }
    ...
    public function setDisplay($v)
    {
        ...
        if ($this->display !== $v) {
            $this->display = $v;
            $this->modifiedColumns[RegionTableMap::COL_DISPLAY] = true;
        }
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            if ($dt !== $this->update_time) {
                $this->update_time = $dt;
                $this->modifiedColumns[RegionTableMap::COL_UPDATE_TIME] = true;
            }
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[RegionTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RegionTableMap::translateFieldName('RegionId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RegionTableMap::translateFieldName('Display', TableMap::TYPE_PHPNAME, $indexType)];
            $this->display = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : RegionTableMap::translateFieldName('UpdateTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->update_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : RegionTableMap::translateFieldName('UpdateUser', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = RegionTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RegionTableMap::COL_REGION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'region_id';
        }
        if ($this->isColumnModified(RegionTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(RegionTableMap::COL_DISPLAY)) {
            $modifiedColumns[':p' . $index++]  = 'display';
        }
        if ($this->isColumnModified(RegionTableMap::COL_UPDATE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'update_time';
        }
        if ($this->isColumnModified(RegionTableMap::COL_UPDATE_USER)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RegionTableMap::COL_REGION_ID)) {
            $criteria->add(RegionTableMap::COL_REGION_ID, $this->region_id);
        }
        if ($this->isColumnModified(RegionTableMap::COL_NAME)) {
            $criteria->add(RegionTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(RegionTableMap::COL_DISPLAY)) {
            $criteria->add(RegionTableMap::COL_DISPLAY, $this->display);
        }
        if ($this->isColumnModified(RegionTableMap::COL_UPDATE_TIME)) {
            $criteria->add(RegionTableMap::COL_UPDATE_TIME, $this->update_time);
        }
        if ($this->isColumnModified(RegionTableMap::COL_UPDATE_USER)) {
            $criteria->add(RegionTableMap::COL_UPDATE_USER, $this->update_user);
        }
