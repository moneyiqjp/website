...
/**
 * Base class that represents a row from the 'point_system_history' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class PointSystemHistory implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PointSystemHistoryTableMap';
    ...
    /**
     * Initializes internal state of Base\PointSystemHistory object.
     */
    ...
    /**
     * Compares this with another <code>PointSystemHistory</code> instance.  If
     * <code>obj</code> is an instance of <code>PointSystemHistory</code>, delegates to
     * <code>equals(PointSystemHistory)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PointSystemHistory The current object, for fluid interface
     */
    ...
    public function setPointSystemId($v)
    {
        ...
        if ($this->point_system_id !== $v) {
            ...
            $this->modifiedColumns[PointSystemHistoryTableMap::COL_POINT_SYSTEM_ID] = true;
        }
    ...
    public function setPointSystemName($v)
    {
        ...
        if ($this->point_system_name !== $v) {
            ...
            $this->modifiedColumns[PointSystemHistoryTableMap::COL_POINT_SYSTEM_NAME] = true;
        }
    ...
    public function setTimeBeg($v)
    {
        ...
        if ($this->time_beg !== null || $dt !== null) {
            if ($dt !== $this->time_beg) {
                $this->time_beg = $dt;
                $this->modifiedColumns[PointSystemHistoryTableMap::COL_TIME_BEG] = true;
            }
    ...
    public function setTimeEnd($v)
    {
        ...
        if ($this->time_end !== null || $dt !== null) {
            if ($dt !== $this->time_end) {
                $this->time_end = $dt;
                $this->modifiedColumns[PointSystemHistoryTableMap::COL_TIME_END] = true;
            }
        } // if either are not null
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[PointSystemHistoryTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PointSystemHistoryTableMap::translateFieldName('PointSystemId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPointSystemHistoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PointSystemHistory::setDeleted()
     * @see PointSystemHistory::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPointSystemHistoryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PointSystemHistoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PointSystemHistoryTableMap::COL_POINT_SYSTEM_ID)) {
        ...
        if ($this->isColumnModified(PointSystemHistoryTableMap::COL_TIME_END)) {
            $modifiedColumns[':p' . $index++]  = 'time_end';
        }
        if ($this->isColumnModified(PointSystemHistoryTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }

        $sql = sprintf(
            'INSERT INTO point_system_history (%s) VALUES (%s)',
    ...
    {
        $pos = PointSystemHistoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['PointSystemHistory'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PointSystemHistory'][$this->hashCode()] = true;
        $keys = PointSystemHistoryTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PointSystemHistory
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PointSystemHistoryTableMap::COL_POINT_SYSTEM_ID)) {
            $criteria->add(PointSystemHistoryTableMap::COL_POINT_SYSTEM_ID, $this->point_system_id);
        }
        if ($this->isColumnModified(PointSystemHistoryTableMap::COL_POINT_SYSTEM_NAME)) {
        ...
        if ($this->isColumnModified(PointSystemHistoryTableMap::COL_TIME_END)) {
            $criteria->add(PointSystemHistoryTableMap::COL_TIME_END, $this->time_end);
        }
        if ($this->isColumnModified(PointSystemHistoryTableMap::COL_UPDATE_USER)) {
            $criteria->add(PointSystemHistoryTableMap::COL_UPDATE_USER, $this->update_user);
        }
    ...
    {
        $criteria = ChildPointSystemHistoryQuery::create();
        $criteria->add(PointSystemHistoryTableMap::COL_POINT_SYSTEM_ID, $this->point_system_id);
        $criteria->add(PointSystemHistoryTableMap::COL_TIME_BEG, $this->time_beg);
    ...
    {
        return (null === $this->getPointSystemId()) && (null === $this->getTimeBeg());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PointSystemHistory (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PointSystemHistory Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PointSystemHistoryTableMap::DEFAULT_STRING_FORMAT);
    }
