...
abstract class CardFeaturesHistory implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CardFeaturesHistoryTableMap';
    ...
    /**
     * Initializes internal state of Base\CardFeaturesHistory object.
     */
    ...
    /**
     * Compares this with another <code>CardFeaturesHistory</code> instance.  If
     * <code>obj</code> is an instance of <code>CardFeaturesHistory</code>, delegates to
     * <code>equals(CardFeaturesHistory)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CardFeaturesHistory The current object, for fluid interface
     */
    ...
    public function setFeatureId($v)
    {
        ...
        if ($this->feature_id !== $v) {
            $this->feature_id = $v;
            $this->modifiedColumns[CardFeaturesHistoryTableMap::COL_FEATURE_ID] = true;
        }
    ...
    public function setFeatureTypeId($v)
    {
        ...
        if ($this->feature_type_id !== $v) {
            ...
            $this->modifiedColumns[CardFeaturesHistoryTableMap::COL_FEATURE_TYPE_ID] = true;
        }
    ...
    public function setCreditCardId($v)
    {
        ...
        if ($this->credit_card_id !== $v) {
            ...
            $this->modifiedColumns[CardFeaturesHistoryTableMap::COL_CREDIT_CARD_ID] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[CardFeaturesHistoryTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setFeatureCost($v)
    {
        ...
        if ($this->feature_cost !== $v) {
            $this->feature_cost = $v;
            $this->modifiedColumns[CardFeaturesHistoryTableMap::COL_FEATURE_COST] = true;
        }
    ...
    public function setTimeBeg($v)
    {
        ...
        if ($this->time_beg !== null || $dt !== null) {
            if ($dt !== $this->time_beg) {
                $this->time_beg = $dt;
                $this->modifiedColumns[CardFeaturesHistoryTableMap::COL_TIME_BEG] = true;
            }
    ...
    public function setTimeEnd($v)
    {
        ...
        if ($this->time_end !== null || $dt !== null) {
            if ($dt !== $this->time_end) {
                $this->time_end = $dt;
                $this->modifiedColumns[CardFeaturesHistoryTableMap::COL_TIME_END] = true;
            }
        } // if either are not null
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[CardFeaturesHistoryTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CardFeaturesHistoryTableMap::translateFieldName('FeatureId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->feature_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CardFeaturesHistoryTableMap::translateFieldName('FeatureTypeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->feature_type_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CardFeaturesHistoryTableMap::translateFieldName('CreditCardId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->credit_card_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CardFeaturesHistoryTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CardFeaturesHistoryTableMap::translateFieldName('FeatureCost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->feature_cost = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CardFeaturesHistoryTableMap::translateFieldName('TimeBeg', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->time_beg = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CardFeaturesHistoryTableMap::translateFieldName('TimeEnd', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->time_end = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CardFeaturesHistoryTableMap::translateFieldName('UpdateUser', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = CardFeaturesHistoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CardFeaturesHistory'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCardFeaturesHistoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CardFeaturesHistory::setDeleted()
     * @see CardFeaturesHistory::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCardFeaturesHistoryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CardFeaturesHistoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_FEATURE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'feature_id';
        }
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_FEATURE_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'feature_type_id';
        }
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_CREDIT_CARD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'credit_card_id';
        }
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_FEATURE_COST)) {
            $modifiedColumns[':p' . $index++]  = 'feature_cost';
        }
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_TIME_BEG)) {
            $modifiedColumns[':p' . $index++]  = 'time_beg';
        }
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_TIME_END)) {
            $modifiedColumns[':p' . $index++]  = 'time_end';
        }
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }

        $sql = sprintf(
            'INSERT INTO card_features_history (%s) VALUES (%s)',
    ...
    {
        $pos = CardFeaturesHistoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CardFeaturesHistory'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CardFeaturesHistory'][$this->hashCode()] = true;
        $keys = CardFeaturesHistoryTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CardFeaturesHistory
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_FEATURE_ID)) {
            $criteria->add(CardFeaturesHistoryTableMap::COL_FEATURE_ID, $this->feature_id);
        }
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_FEATURE_TYPE_ID)) {
            $criteria->add(CardFeaturesHistoryTableMap::COL_FEATURE_TYPE_ID, $this->feature_type_id);
        }
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_CREDIT_CARD_ID)) {
            $criteria->add(CardFeaturesHistoryTableMap::COL_CREDIT_CARD_ID, $this->credit_card_id);
        }
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_DESCRIPTION)) {
            $criteria->add(CardFeaturesHistoryTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_FEATURE_COST)) {
            $criteria->add(CardFeaturesHistoryTableMap::COL_FEATURE_COST, $this->feature_cost);
        }
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_TIME_BEG)) {
            $criteria->add(CardFeaturesHistoryTableMap::COL_TIME_BEG, $this->time_beg);
        }
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_TIME_END)) {
            $criteria->add(CardFeaturesHistoryTableMap::COL_TIME_END, $this->time_end);
        }
        if ($this->isColumnModified(CardFeaturesHistoryTableMap::COL_UPDATE_USER)) {
            $criteria->add(CardFeaturesHistoryTableMap::COL_UPDATE_USER, $this->update_user);
        }
    ...
    {
        $criteria = ChildCardFeaturesHistoryQuery::create();
        $criteria->add(CardFeaturesHistoryTableMap::COL_FEATURE_ID, $this->feature_id);
        $criteria->add(CardFeaturesHistoryTableMap::COL_TIME_BEG, $this->time_beg);
    ...
    {
        return (null === $this->getFeatureId()) && (null === $this->getTimeBeg());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CardFeaturesHistory (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CardFeaturesHistory Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CardFeaturesHistoryTableMap::DEFAULT_STRING_FORMAT);
    }
