...
/**
 * Base class that represents a row from the 'discounts' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class Discounts implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\DiscountsTableMap';
    ...
    /**
     * Initializes internal state of Base\Discounts object.
     */
    ...
    /**
     * Compares this with another <code>Discounts</code> instance.  If
     * <code>obj</code> is an instance of <code>Discounts</code>, delegates to
     * <code>equals(Discounts)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Discounts The current object, for fluid interface
     */
    ...
    public function setDiscountId($v)
    {
        ...
        if ($this->discount_id !== $v) {
            $this->discount_id = $v;
            $this->modifiedColumns[DiscountsTableMap::COL_DISCOUNT_ID] = true;
        }
    ...
    public function setPercentage($v)
    {
        ...
        if ($this->percentage !== $v) {
            $this->percentage = $v;
            $this->modifiedColumns[DiscountsTableMap::COL_PERCENTAGE] = true;
        }
    ...
    public function setStartDate($v)
    {
        ...
        if ($this->start_date !== null || $dt !== null) {
            if ($dt !== $this->start_date) {
                $this->start_date = $dt;
                $this->modifiedColumns[DiscountsTableMap::COL_START_DATE] = true;
            }
    ...
    public function setEndDate($v)
    {
        ...
        if ($this->end_date !== null || $dt !== null) {
            if ($dt !== $this->end_date) {
                $this->end_date = $dt;
                $this->modifiedColumns[DiscountsTableMap::COL_END_DATE] = true;
            }
        } // if either are not null
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[DiscountsTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setCreditCardId($v)
    {
        ...
        if ($this->credit_card_id !== $v) {
            ...
            $this->modifiedColumns[DiscountsTableMap::COL_CREDIT_CARD_ID] = true;
        }
    ...
    public function setStoreId($v)
    {
        ...
        if ($this->store_id !== $v) {
            $this->store_id = $v;
            $this->modifiedColumns[DiscountsTableMap::COL_STORE_ID] = true;
        }
    ...
    public function setMultiple($v)
    {
        ...
        if ($this->multiple !== $v) {
            $this->multiple = $v;
            $this->modifiedColumns[DiscountsTableMap::COL_MULTIPLE] = true;
        }
    ...
    public function setConditions($v)
    {
        ...
        if ($this->conditions !== $v) {
            $this->conditions = $v;
            $this->modifiedColumns[DiscountsTableMap::COL_CONDITIONS] = true;
        }
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            if ($dt !== $this->update_time) {
                $this->update_time = $dt;
                $this->modifiedColumns[DiscountsTableMap::COL_UPDATE_TIME] = true;
            }
        } // if either are not null
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[DiscountsTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DiscountsTableMap::translateFieldName('DiscountId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discount_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DiscountsTableMap::translateFieldName('Percentage', TableMap::TYPE_PHPNAME, $indexType)];
            $this->percentage = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DiscountsTableMap::translateFieldName('StartDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->start_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : DiscountsTableMap::translateFieldName('EndDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->end_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : DiscountsTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : DiscountsTableMap::translateFieldName('CreditCardId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->credit_card_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : DiscountsTableMap::translateFieldName('StoreId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->store_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : DiscountsTableMap::translateFieldName('Multiple', TableMap::TYPE_PHPNAME, $indexType)];
            $this->multiple = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : DiscountsTableMap::translateFieldName('Conditions', TableMap::TYPE_PHPNAME, $indexType)];
            $this->conditions = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : DiscountsTableMap::translateFieldName('UpdateTime', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDiscountsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Discounts::setDeleted()
     * @see Discounts::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDiscountsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DiscountsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DiscountsTableMap::COL_DISCOUNT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'discount_id';
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_PERCENTAGE)) {
            $modifiedColumns[':p' . $index++]  = 'percentage';
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_START_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'start_date';
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_END_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'end_date';
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_CREDIT_CARD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'credit_card_id';
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_STORE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'store_id';
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_MULTIPLE)) {
            $modifiedColumns[':p' . $index++]  = 'multiple';
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_CONDITIONS)) {
            $modifiedColumns[':p' . $index++]  = 'conditions';
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_UPDATE_TIME)) {
    ...
    {
        $pos = DiscountsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Discounts'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Discounts'][$this->hashCode()] = true;
        $keys = DiscountsTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DiscountsTableMap::COL_DISCOUNT_ID)) {
            $criteria->add(DiscountsTableMap::COL_DISCOUNT_ID, $this->discount_id);
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_PERCENTAGE)) {
            $criteria->add(DiscountsTableMap::COL_PERCENTAGE, $this->percentage);
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_START_DATE)) {
            $criteria->add(DiscountsTableMap::COL_START_DATE, $this->start_date);
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_END_DATE)) {
            $criteria->add(DiscountsTableMap::COL_END_DATE, $this->end_date);
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_DESCRIPTION)) {
            $criteria->add(DiscountsTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_CREDIT_CARD_ID)) {
            $criteria->add(DiscountsTableMap::COL_CREDIT_CARD_ID, $this->credit_card_id);
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_STORE_ID)) {
            $criteria->add(DiscountsTableMap::COL_STORE_ID, $this->store_id);
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_MULTIPLE)) {
            $criteria->add(DiscountsTableMap::COL_MULTIPLE, $this->multiple);
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_CONDITIONS)) {
            $criteria->add(DiscountsTableMap::COL_CONDITIONS, $this->conditions);
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_UPDATE_TIME)) {
            $criteria->add(DiscountsTableMap::COL_UPDATE_TIME, $this->update_time);
        }
        if ($this->isColumnModified(DiscountsTableMap::COL_UPDATE_USER)) {
    ...
    {
        $criteria = ChildDiscountsQuery::create();
        $criteria->add(DiscountsTableMap::COL_DISCOUNT_ID, $this->discount_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Discounts (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Discounts Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCreditCard(ConnectionInterface $con = null)
    {
        if ($this->aCreditCard === null && ($this->credit_card_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCreditCard->addDiscountss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DiscountsTableMap::DEFAULT_STRING_FORMAT);
    }
