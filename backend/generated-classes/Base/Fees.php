...
abstract class Fees implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\FeesTableMap';
    ...
    /**
     * Initializes internal state of Base\Fees object.
     */
    ...
    /**
     * Compares this with another <code>Fees</code> instance.  If
     * <code>obj</code> is an instance of <code>Fees</code>, delegates to
     * <code>equals(Fees)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Fees The current object, for fluid interface
     */
    ...
    public function setFeeId($v)
    {
        ...
        if ($this->fee_id !== $v) {
            $this->fee_id = $v;
            $this->modifiedColumns[FeesTableMap::COL_FEE_ID] = true;
        }
    ...
    public function setFeeType($v)
    {
        ...
        if ($this->fee_type !== $v) {
            $this->fee_type = $v;
            $this->modifiedColumns[FeesTableMap::COL_FEE_TYPE] = true;
        }
    ...
    public function setFeeAmount($v)
    {
        ...
        if ($this->fee_amount !== $v) {
            $this->fee_amount = $v;
            $this->modifiedColumns[FeesTableMap::COL_FEE_AMOUNT] = true;
        }
    ...
    public function setYearlyOccurrence($v)
    {
        ...
        if ($this->yearly_occurrence !== $v) {
            ...
            $this->modifiedColumns[FeesTableMap::COL_YEARLY_OCCURRENCE] = true;
        }
    ...
    public function setStartYear($v)
    {
        ...
        if ($this->start_year !== $v) {
            $this->start_year = $v;
            $this->modifiedColumns[FeesTableMap::COL_START_YEAR] = true;
        }
    ...
    public function setEndYear($v)
    {
        ...
        if ($this->end_year !== $v) {
            $this->end_year = $v;
            $this->modifiedColumns[FeesTableMap::COL_END_YEAR] = true;
        }
    ...
    public function setCreditCardId($v)
    {
        ...
        if ($this->credit_card_id !== $v) {
            ...
            $this->modifiedColumns[FeesTableMap::COL_CREDIT_CARD_ID] = true;
        }
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            if ($dt !== $this->update_time) {
                $this->update_time = $dt;
                $this->modifiedColumns[FeesTableMap::COL_UPDATE_TIME] = true;
            }
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[FeesTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FeesTableMap::translateFieldName('FeeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fee_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FeesTableMap::translateFieldName('FeeType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fee_type = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FeesTableMap::translateFieldName('FeeAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fee_amount = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : FeesTableMap::translateFieldName('YearlyOccurrence', TableMap::TYPE_PHPNAME, $indexType)];
            $this->yearly_occurrence = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : FeesTableMap::translateFieldName('StartYear', TableMap::TYPE_PHPNAME, $indexType)];
            $this->start_year = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : FeesTableMap::translateFieldName('EndYear', TableMap::TYPE_PHPNAME, $indexType)];
            $this->end_year = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : FeesTableMap::translateFieldName('CreditCardId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->credit_card_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : FeesTableMap::translateFieldName('UpdateTime', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFeesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildFeesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FeesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FeesTableMap::COL_FEE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'fee_id';
        }
        if ($this->isColumnModified(FeesTableMap::COL_FEE_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'fee_type';
        }
        if ($this->isColumnModified(FeesTableMap::COL_FEE_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'fee_amount';
        }
        if ($this->isColumnModified(FeesTableMap::COL_YEARLY_OCCURRENCE)) {
            $modifiedColumns[':p' . $index++]  = 'yearly_occurrence';
        }
        if ($this->isColumnModified(FeesTableMap::COL_START_YEAR)) {
            $modifiedColumns[':p' . $index++]  = 'start_year';
        }
        if ($this->isColumnModified(FeesTableMap::COL_END_YEAR)) {
            $modifiedColumns[':p' . $index++]  = 'end_year';
        }
        if ($this->isColumnModified(FeesTableMap::COL_CREDIT_CARD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'credit_card_id';
        }
        if ($this->isColumnModified(FeesTableMap::COL_UPDATE_TIME)) {
    ...
    {
        $pos = FeesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Fees'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Fees'][$this->hashCode()] = true;
        $keys = FeesTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FeesTableMap::COL_FEE_ID)) {
            $criteria->add(FeesTableMap::COL_FEE_ID, $this->fee_id);
        }
        if ($this->isColumnModified(FeesTableMap::COL_FEE_TYPE)) {
            $criteria->add(FeesTableMap::COL_FEE_TYPE, $this->fee_type);
        }
        if ($this->isColumnModified(FeesTableMap::COL_FEE_AMOUNT)) {
            $criteria->add(FeesTableMap::COL_FEE_AMOUNT, $this->fee_amount);
        }
        if ($this->isColumnModified(FeesTableMap::COL_YEARLY_OCCURRENCE)) {
            $criteria->add(FeesTableMap::COL_YEARLY_OCCURRENCE, $this->yearly_occurrence);
        }
        if ($this->isColumnModified(FeesTableMap::COL_START_YEAR)) {
            $criteria->add(FeesTableMap::COL_START_YEAR, $this->start_year);
        }
        if ($this->isColumnModified(FeesTableMap::COL_END_YEAR)) {
            $criteria->add(FeesTableMap::COL_END_YEAR, $this->end_year);
        }
        if ($this->isColumnModified(FeesTableMap::COL_CREDIT_CARD_ID)) {
            $criteria->add(FeesTableMap::COL_CREDIT_CARD_ID, $this->credit_card_id);
        }
        if ($this->isColumnModified(FeesTableMap::COL_UPDATE_TIME)) {
            $criteria->add(FeesTableMap::COL_UPDATE_TIME, $this->update_time);
        }
        if ($this->isColumnModified(FeesTableMap::COL_UPDATE_USER)) {
    ...
    {
        $criteria = ChildFeesQuery::create();
        $criteria->add(FeesTableMap::COL_FEE_ID, $this->fee_id);
    ...
    /**
     * Generic method to set the primary key (fee_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Fees (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Fees Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCreditCard(ConnectionInterface $con = null)
    {
        if ($this->aCreditCard === null && ($this->credit_card_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCreditCard->addFeess($this);
             */
        }
    ...
    {
        if (null !== $this->aCreditCard) {
            $this->aCreditCard->removeFees($this);
        }
        $this->fee_id = null;
        $this->fee_type = null;
    ...
    {
        return (string) $this->exportTo(FeesTableMap::DEFAULT_STRING_FORMAT);
    }
