...
/**
 * Base class that represents a row from the 'map_persona_feature_constraint' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class MapPersonaFeatureConstraint implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MapPersonaFeatureConstraintTableMap';
    ...
    /**
     * Initializes internal state of Base\MapPersonaFeatureConstraint object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>MapPersonaFeatureConstraint</code> instance.  If
     * <code>obj</code> is an instance of <code>MapPersonaFeatureConstraint</code>, delegates to
     * <code>equals(MapPersonaFeatureConstraint)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MapPersonaFeatureConstraint The current object, for fluid interface
     */
    ...
    public function setPersonaId($v)
    {
        ...
        if ($this->persona_id !== $v) {
            $this->persona_id = $v;
            $this->modifiedColumns[MapPersonaFeatureConstraintTableMap::COL_PERSONA_ID] = true;
        }
    ...
    public function setFeatureTypeId($v)
    {
        ...
        if ($this->feature_type_id !== $v) {
            ...
            $this->modifiedColumns[MapPersonaFeatureConstraintTableMap::COL_FEATURE_TYPE_ID] = true;
        }
    ...
    public function setPriorityId($v)
    {
        ...
        if ($this->priority_id !== $v) {
            $this->priority_id = $v;
            $this->modifiedColumns[MapPersonaFeatureConstraintTableMap::COL_PRIORITY_ID] = true;
        }
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            if ($dt !== $this->update_time) {
                $this->update_time = $dt;
                $this->modifiedColumns[MapPersonaFeatureConstraintTableMap::COL_UPDATE_TIME] = true;
            }
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[MapPersonaFeatureConstraintTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MapPersonaFeatureConstraintTableMap::translateFieldName('PersonaId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->persona_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MapPersonaFeatureConstraintTableMap::translateFieldName('FeatureTypeId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMapPersonaFeatureConstraintQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MapPersonaFeatureConstraint::setDeleted()
     * @see MapPersonaFeatureConstraint::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMapPersonaFeatureConstraintQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MapPersonaFeatureConstraintTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MapPersonaFeatureConstraintTableMap::COL_PERSONA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'persona_id';
        }
        if ($this->isColumnModified(MapPersonaFeatureConstraintTableMap::COL_FEATURE_TYPE_ID)) {
        ...
        if ($this->isColumnModified(MapPersonaFeatureConstraintTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }

        $sql = sprintf(
            'INSERT INTO map_persona_feature_constraint (%s) VALUES (%s)',
    ...
    {
        $pos = MapPersonaFeatureConstraintTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MapPersonaFeatureConstraint'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MapPersonaFeatureConstraint'][$this->hashCode()] = true;
        $keys = MapPersonaFeatureConstraintTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MapPersonaFeatureConstraint
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MapPersonaFeatureConstraintTableMap::COL_PERSONA_ID)) {
            $criteria->add(MapPersonaFeatureConstraintTableMap::COL_PERSONA_ID, $this->persona_id);
        }
        if ($this->isColumnModified(MapPersonaFeatureConstraintTableMap::COL_FEATURE_TYPE_ID)) {
            $criteria->add(MapPersonaFeatureConstraintTableMap::COL_FEATURE_TYPE_ID, $this->feature_type_id);
        }
        if ($this->isColumnModified(MapPersonaFeatureConstraintTableMap::COL_PRIORITY_ID)) {
        ...
        if ($this->isColumnModified(MapPersonaFeatureConstraintTableMap::COL_UPDATE_USER)) {
            $criteria->add(MapPersonaFeatureConstraintTableMap::COL_UPDATE_USER, $this->update_user);
        }
    ...
    {
        $criteria = ChildMapPersonaFeatureConstraintQuery::create();
        $criteria->add(MapPersonaFeatureConstraintTableMap::COL_PERSONA_ID, $this->persona_id);
        $criteria->add(MapPersonaFeatureConstraintTableMap::COL_FEATURE_TYPE_ID, $this->feature_type_id);
    ...
    public function hashCode()
    {
        ...
        //relation FK_mpfc_feature_type_id to table card_feature_type
        ...
        //relation FK_mpfc_persona_id to table persona
    ...
    {
        return (null === $this->getPersonaId()) && (null === $this->getFeatureTypeId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MapPersonaFeatureConstraint (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MapPersonaFeatureConstraint Clone of current object.
     * @throws PropelException
     */
    ...
    public function setCardFeatureType(ChildCardFeatureType $v = null)
    {
        ...
        if ($v !== null) {
            $v->addMapPersonaFeatureConstraint($this);
        }
    ...
    public function getCardFeatureType(ConnectionInterface $con = null)
    {
        if ($this->aCardFeatureType === null && ($this->feature_type_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCardFeatureType->addMapPersonaFeatureConstraints($this);
             */
        }
    ...
    public function getPersona(ConnectionInterface $con = null)
    {
        if ($this->aPersona === null && ($this->persona_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPersona->addMapPersonaFeatureConstraints($this);
             */
        }
    ...
    {
        if (null !== $this->aCardFeatureType) {
            $this->aCardFeatureType->removeMapPersonaFeatureConstraint($this);
        }
        if (null !== $this->aPersona) {
            $this->aPersona->removeMapPersonaFeatureConstraint($this);
        }
    ...
    {
        return (string) $this->exportTo(MapPersonaFeatureConstraintTableMap::DEFAULT_STRING_FORMAT);
    }
