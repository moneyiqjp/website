...
abstract class PointUsageHistory implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PointUsageHistoryTableMap';
    ...
    /**
     * Initializes internal state of Base\PointUsageHistory object.
     */
    ...
    /**
     * Compares this with another <code>PointUsageHistory</code> instance.  If
     * <code>obj</code> is an instance of <code>PointUsageHistory</code>, delegates to
     * <code>equals(PointUsageHistory)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PointUsageHistory The current object, for fluid interface
     */
    ...
    public function setPointUsageId($v)
    {
        ...
        if ($this->point_usage_id !== $v) {
            ...
            $this->modifiedColumns[PointUsageHistoryTableMap::COL_POINT_USAGE_ID] = true;
        }
    ...
    public function setStoreId($v)
    {
        ...
        if ($this->store_id !== $v) {
            $this->store_id = $v;
            $this->modifiedColumns[PointUsageHistoryTableMap::COL_STORE_ID] = true;
        }
    ...
    public function setYenPerPoint($v)
    {
        ...
        if ($this->yen_per_point !== $v) {
            ...
            $this->modifiedColumns[PointUsageHistoryTableMap::COL_YEN_PER_POINT] = true;
        }
    ...
    public function setCreditCardId($v)
    {
        ...
        if ($this->credit_card_id !== $v) {
            ...
            $this->modifiedColumns[PointUsageHistoryTableMap::COL_CREDIT_CARD_ID] = true;
        }
    ...
    public function setTimeBeg($v)
    {
        ...
        if ($this->time_beg !== null || $dt !== null) {
            if ($dt !== $this->time_beg) {
                $this->time_beg = $dt;
                $this->modifiedColumns[PointUsageHistoryTableMap::COL_TIME_BEG] = true;
            }
    ...
    public function setTimeEnd($v)
    {
        ...
        if ($this->time_end !== null || $dt !== null) {
            if ($dt !== $this->time_end) {
                $this->time_end = $dt;
                $this->modifiedColumns[PointUsageHistoryTableMap::COL_TIME_END] = true;
            }
        } // if either are not null
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[PointUsageHistoryTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PointUsageHistoryTableMap::translateFieldName('PointUsageId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->point_usage_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PointUsageHistoryTableMap::translateFieldName('StoreId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PointUsageHistoryTableMap::translateFieldName('TimeBeg', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->time_beg = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PointUsageHistoryTableMap::translateFieldName('TimeEnd', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->time_end = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : PointUsageHistoryTableMap::translateFieldName('UpdateUser', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = PointUsageHistoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PointUsageHistory'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPointUsageHistoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PointUsageHistory::setDeleted()
     * @see PointUsageHistory::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPointUsageHistoryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PointUsageHistoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PointUsageHistoryTableMap::COL_POINT_USAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'point_usage_id';
        }
        if ($this->isColumnModified(PointUsageHistoryTableMap::COL_STORE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'store_id';
        }
        if ($this->isColumnModified(PointUsageHistoryTableMap::COL_YEN_PER_POINT)) {
            $modifiedColumns[':p' . $index++]  = 'yen_per_point';
        }
        if ($this->isColumnModified(PointUsageHistoryTableMap::COL_CREDIT_CARD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'credit_card_id';
        }
        if ($this->isColumnModified(PointUsageHistoryTableMap::COL_TIME_BEG)) {
            $modifiedColumns[':p' . $index++]  = 'time_beg';
        }
        if ($this->isColumnModified(PointUsageHistoryTableMap::COL_TIME_END)) {
            $modifiedColumns[':p' . $index++]  = 'time_end';
        }
        if ($this->isColumnModified(PointUsageHistoryTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }

        $sql = sprintf(
            'INSERT INTO point_usage_history (%s) VALUES (%s)',
    ...
    {
        $pos = PointUsageHistoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['PointUsageHistory'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PointUsageHistory'][$this->hashCode()] = true;
        $keys = PointUsageHistoryTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PointUsageHistoryTableMap::COL_POINT_USAGE_ID)) {
            $criteria->add(PointUsageHistoryTableMap::COL_POINT_USAGE_ID, $this->point_usage_id);
        }
        if ($this->isColumnModified(PointUsageHistoryTableMap::COL_STORE_ID)) {
            $criteria->add(PointUsageHistoryTableMap::COL_STORE_ID, $this->store_id);
        }
        if ($this->isColumnModified(PointUsageHistoryTableMap::COL_YEN_PER_POINT)) {
            $criteria->add(PointUsageHistoryTableMap::COL_YEN_PER_POINT, $this->yen_per_point);
        }
        if ($this->isColumnModified(PointUsageHistoryTableMap::COL_CREDIT_CARD_ID)) {
            $criteria->add(PointUsageHistoryTableMap::COL_CREDIT_CARD_ID, $this->credit_card_id);
        }
        if ($this->isColumnModified(PointUsageHistoryTableMap::COL_TIME_BEG)) {
            $criteria->add(PointUsageHistoryTableMap::COL_TIME_BEG, $this->time_beg);
        }
        if ($this->isColumnModified(PointUsageHistoryTableMap::COL_TIME_END)) {
            $criteria->add(PointUsageHistoryTableMap::COL_TIME_END, $this->time_end);
        }
        if ($this->isColumnModified(PointUsageHistoryTableMap::COL_UPDATE_USER)) {
            $criteria->add(PointUsageHistoryTableMap::COL_UPDATE_USER, $this->update_user);
        }
    ...
    {
        $criteria = ChildPointUsageHistoryQuery::create();
        $criteria->add(PointUsageHistoryTableMap::COL_POINT_USAGE_ID, $this->point_usage_id);
        $criteria->add(PointUsageHistoryTableMap::COL_TIME_BEG, $this->time_beg);
    ...
    {
        return (null === $this->getPointUsageId()) && (null === $this->getTimeBeg());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PointUsageHistory (or compatible) type.
    ...
    {
        $copyObj->setPointUsageId($this->getPointUsageId());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PointUsageHistory Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PointUsageHistoryTableMap::DEFAULT_STRING_FORMAT);
    }
