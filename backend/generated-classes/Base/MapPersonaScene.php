...
abstract class MapPersonaScene implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MapPersonaSceneTableMap';
    ...
    /**
     * Initializes internal state of Base\MapPersonaScene object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>MapPersonaScene</code> instance.  If
     * <code>obj</code> is an instance of <code>MapPersonaScene</code>, delegates to
     * <code>equals(MapPersonaScene)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MapPersonaScene The current object, for fluid interface
     */
    ...
    public function setPersonaId($v)
    {
        ...
        if ($this->persona_id !== $v) {
            $this->persona_id = $v;
            $this->modifiedColumns[MapPersonaSceneTableMap::COL_PERSONA_ID] = true;
        }
    ...
    public function setSceneId($v)
    {
        ...
        if ($this->scene_id !== $v) {
            $this->scene_id = $v;
            $this->modifiedColumns[MapPersonaSceneTableMap::COL_SCENE_ID] = true;
        }
    ...
    public function setPriorityId($v)
    {
        ...
        if ($this->priority_id !== $v) {
            $this->priority_id = $v;
            $this->modifiedColumns[MapPersonaSceneTableMap::COL_PRIORITY_ID] = true;
        }
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            if ($dt !== $this->update_time) {
                $this->update_time = $dt;
                $this->modifiedColumns[MapPersonaSceneTableMap::COL_UPDATE_TIME] = true;
            }
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[MapPersonaSceneTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MapPersonaSceneTableMap::translateFieldName('PersonaId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMapPersonaSceneQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MapPersonaScene::setDeleted()
     * @see MapPersonaScene::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMapPersonaSceneQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MapPersonaSceneTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MapPersonaSceneTableMap::COL_PERSONA_ID)) {
        ...
        if ($this->isColumnModified(MapPersonaSceneTableMap::COL_UPDATE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'update_time';
        }
        if ($this->isColumnModified(MapPersonaSceneTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }

        $sql = sprintf(
            'INSERT INTO map_persona_scene (%s) VALUES (%s)',
    ...
    {
        $pos = MapPersonaSceneTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MapPersonaScene'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MapPersonaScene'][$this->hashCode()] = true;
        $keys = MapPersonaSceneTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MapPersonaSceneTableMap::COL_PERSONA_ID)) {
            $criteria->add(MapPersonaSceneTableMap::COL_PERSONA_ID, $this->persona_id);
        }
        if ($this->isColumnModified(MapPersonaSceneTableMap::COL_SCENE_ID)) {
        ...
        if ($this->isColumnModified(MapPersonaSceneTableMap::COL_UPDATE_TIME)) {
            $criteria->add(MapPersonaSceneTableMap::COL_UPDATE_TIME, $this->update_time);
        }
        if ($this->isColumnModified(MapPersonaSceneTableMap::COL_UPDATE_USER)) {
            $criteria->add(MapPersonaSceneTableMap::COL_UPDATE_USER, $this->update_user);
        }
    ...
    {
        $criteria = ChildMapPersonaSceneQuery::create();
        $criteria->add(MapPersonaSceneTableMap::COL_PERSONA_ID, $this->persona_id);
        $criteria->add(MapPersonaSceneTableMap::COL_SCENE_ID, $this->scene_id);
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getPersonaId() &&
            null !== $this->getSceneId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation fk_persona_id_ind to table persona
        ...
        //relation fk_scene_id_ind to table scene
    ...
    {
        return (null === $this->getPersonaId()) && (null === $this->getSceneId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MapPersonaScene (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MapPersonaScene Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPersona(ConnectionInterface $con = null)
    {
        if ($this->aPersona === null && ($this->persona_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPersona->addMapPersonaScenes($this);
             */
        }
    ...
    public function getScene(ConnectionInterface $con = null)
    {
        if ($this->aScene === null && ($this->scene_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aScene->addMapPersonaScenes($this);
             */
        }
    ...
    {
        if (null !== $this->aPersona) {
            $this->aPersona->removeMapPersonaScene($this);
        }
        if (null !== $this->aScene) {
            $this->aScene->removeMapPersonaScene($this);
        }
    ...
    {
        return (string) $this->exportTo(MapPersonaSceneTableMap::DEFAULT_STRING_FORMAT);
    }
