...
abstract class Campaign implements ActiveRecordInterface 
{
     ...
     * Note: this column has a database default value of: '9999-12-31'
     * @var        \DateTime
     */
    protected $end_date;
    ...
    public function applyDefaultValues()
    {
        ...
        $this->end_date = PropelDateTime::newInstance('9999-12-31', null, 'DateTime');
    }
    ...
    public function setCampaignId($v)
    {
        ...
        if ($this->campaign_id !== $v) {
            $this->campaign_id = $v;
            $this->modifiedColumns[CampaignTableMap::COL_CAMPAIGN_ID] = true;
        }
    ...
    public function setCreditCardId($v)
    {
        ...
        if ($this->credit_card_id !== $v) {
            ...
            $this->modifiedColumns[CampaignTableMap::COL_CREDIT_CARD_ID] = true;
        }
    ...
    public function setCampaignName($v)
    {
        ...
        if ($this->campaign_name !== $v) {
            ...
            $this->modifiedColumns[CampaignTableMap::COL_CAMPAIGN_NAME] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[CampaignTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setMaxPoints($v)
    {
        ...
        if ($this->max_points !== $v) {
            $this->max_points = $v;
            $this->modifiedColumns[CampaignTableMap::COL_MAX_POINTS] = true;
        }
    ...
    public function setValueInYen($v)
    {
        ...
        if ($this->value_in_yen !== $v) {
            $this->value_in_yen = $v;
            $this->modifiedColumns[CampaignTableMap::COL_VALUE_IN_YEN] = true;
        }
    ...
    public function setStartDate($v)
    {
        ...
        if ($this->start_date !== null || $dt !== null) {
            if ( ($dt != $this->start_date) // normalized values don't match
                ...
                $this->start_date = $dt;
                $this->modifiedColumns[CampaignTableMap::COL_START_DATE] = true;
            }
    ...
    public function setEndDate($v)
    {
        ...
        if ($this->end_date !== null || $dt !== null) {
            if ( ($dt != $this->end_date) // normalized values don't match
                || ($dt->format('Y-m-d') === '9999-12-31') // or the entered value matches the default
                 ) {
                $this->end_date = $dt;
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            if ($dt !== $this->update_time) {
                $this->update_time = $dt;
                $this->modifiedColumns[CampaignTableMap::COL_UPDATE_TIME] = true;
            }
        } // if either are not null
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[CampaignTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function setReference($v)
    {
        ...
        if ($this->reference !== $v) {
            $this->reference = $v;
            $this->modifiedColumns[CampaignTableMap::COL_REFERENCE] = true;
        }
    ...
    public function hasOnlyDefaultValues()
    {
            ...
            if ($this->end_date && $this->end_date->format('Y-m-d') !== '9999-12-31') {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CampaignTableMap::translateFieldName('CampaignId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->campaign_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CampaignTableMap::translateFieldName('CreditCardId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->credit_card_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CampaignTableMap::translateFieldName('CampaignName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->campaign_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CampaignTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CampaignTableMap::translateFieldName('MaxPoints', TableMap::TYPE_PHPNAME, $indexType)];
            $this->max_points = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CampaignTableMap::translateFieldName('ValueInYen', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value_in_yen = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CampaignTableMap::translateFieldName('StartDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->start_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CampaignTableMap::translateFieldName('EndDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->end_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CampaignTableMap::translateFieldName('UpdateTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->update_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CampaignTableMap::translateFieldName('UpdateUser', TableMap::TYPE_PHPNAME, $indexType)];
            $this->update_user = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : CampaignTableMap::translateFieldName('Reference', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 11; // 11 = CampaignTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CampaignTableMap::COL_CAMPAIGN_ID)) {
            $modifiedColumns[':p' . $index++]  = 'campaign_id';
        }
        if ($this->isColumnModified(CampaignTableMap::COL_CREDIT_CARD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'credit_card_id';
        }
        if ($this->isColumnModified(CampaignTableMap::COL_CAMPAIGN_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'campaign_name';
        }
        if ($this->isColumnModified(CampaignTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(CampaignTableMap::COL_MAX_POINTS)) {
            $modifiedColumns[':p' . $index++]  = 'max_points';
        }
        if ($this->isColumnModified(CampaignTableMap::COL_VALUE_IN_YEN)) {
            $modifiedColumns[':p' . $index++]  = 'value_in_yen';
        }
        if ($this->isColumnModified(CampaignTableMap::COL_START_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'start_date';
        }
        if ($this->isColumnModified(CampaignTableMap::COL_END_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'end_date';
        }
        if ($this->isColumnModified(CampaignTableMap::COL_UPDATE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'update_time';
        }
        if ($this->isColumnModified(CampaignTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }
        if ($this->isColumnModified(CampaignTableMap::COL_REFERENCE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CampaignTableMap::COL_CAMPAIGN_ID)) {
            $criteria->add(CampaignTableMap::COL_CAMPAIGN_ID, $this->campaign_id);
        }
        if ($this->isColumnModified(CampaignTableMap::COL_CREDIT_CARD_ID)) {
            $criteria->add(CampaignTableMap::COL_CREDIT_CARD_ID, $this->credit_card_id);
        }
        if ($this->isColumnModified(CampaignTableMap::COL_CAMPAIGN_NAME)) {
            $criteria->add(CampaignTableMap::COL_CAMPAIGN_NAME, $this->campaign_name);
        }
        if ($this->isColumnModified(CampaignTableMap::COL_DESCRIPTION)) {
            $criteria->add(CampaignTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(CampaignTableMap::COL_MAX_POINTS)) {
            $criteria->add(CampaignTableMap::COL_MAX_POINTS, $this->max_points);
        }
        if ($this->isColumnModified(CampaignTableMap::COL_VALUE_IN_YEN)) {
            $criteria->add(CampaignTableMap::COL_VALUE_IN_YEN, $this->value_in_yen);
        }
        if ($this->isColumnModified(CampaignTableMap::COL_START_DATE)) {
            $criteria->add(CampaignTableMap::COL_START_DATE, $this->start_date);
        }
        if ($this->isColumnModified(CampaignTableMap::COL_END_DATE)) {
            $criteria->add(CampaignTableMap::COL_END_DATE, $this->end_date);
        }
        if ($this->isColumnModified(CampaignTableMap::COL_UPDATE_TIME)) {
            $criteria->add(CampaignTableMap::COL_UPDATE_TIME, $this->update_time);
        }
        if ($this->isColumnModified(CampaignTableMap::COL_UPDATE_USER)) {
            $criteria->add(CampaignTableMap::COL_UPDATE_USER, $this->update_user);
        }
        if ($this->isColumnModified(CampaignTableMap::COL_REFERENCE)) {
            $criteria->add(CampaignTableMap::COL_REFERENCE, $this->reference);
        }
    ...
    public function getCreditCard(ConnectionInterface $con = null)
    {
        if ($this->aCreditCard === null && ($this->credit_card_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCreditCard->addCampaigns($this);
             */
        }
    ...
    {
        if (null !== $this->aCreditCard) {
            $this->aCreditCard->removeCampaign($this);
        }
