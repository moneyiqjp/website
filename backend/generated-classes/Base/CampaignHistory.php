...
abstract class CampaignHistory implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CampaignHistoryTableMap';
     ...
     * Note: this column has a database default value of: '1000-01-01'
     * @var        \DateTime
     */
    ...
    {
        $this->start_date = PropelDateTime::newInstance('1000-01-01', null, 'DateTime');
    }

    /**
     * Initializes internal state of Base\CampaignHistory object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CampaignHistory</code> instance.  If
     * <code>obj</code> is an instance of <code>CampaignHistory</code>, delegates to
     * <code>equals(CampaignHistory)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CampaignHistory The current object, for fluid interface
     */
    ...
    public function setCampaignId($v)
    {
        ...
        if ($this->campaign_id !== $v) {
            $this->campaign_id = $v;
            $this->modifiedColumns[CampaignHistoryTableMap::COL_CAMPAIGN_ID] = true;
        }
    ...
    public function setCreditCardId($v)
    {
        ...
        if ($this->credit_card_id !== $v) {
            ...
            $this->modifiedColumns[CampaignHistoryTableMap::COL_CREDIT_CARD_ID] = true;
        }
    ...
    public function setCampaignName($v)
    {
        ...
        if ($this->campaign_name !== $v) {
            ...
            $this->modifiedColumns[CampaignHistoryTableMap::COL_CAMPAIGN_NAME] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[CampaignHistoryTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setMaxPoints($v)
    {
        ...
        if ($this->max_points !== $v) {
            $this->max_points = $v;
            $this->modifiedColumns[CampaignHistoryTableMap::COL_MAX_POINTS] = true;
        }
    ...
    public function setValueInYen($v)
    {
        ...
        if ($this->value_in_yen !== $v) {
            $this->value_in_yen = $v;
            $this->modifiedColumns[CampaignHistoryTableMap::COL_VALUE_IN_YEN] = true;
        }
    ...
    public function setStartDate($v)
    {
        ...
        if ($this->start_date !== null || $dt !== null) {
            if ( ($dt != $this->start_date) // normalized values don't match
                || ($dt->format('Y-m-d') === '1000-01-01') // or the entered value matches the default
                 ) {
                $this->start_date = $dt;
                $this->modifiedColumns[CampaignHistoryTableMap::COL_START_DATE] = true;
            }
    ...
    public function setEndDate($v)
    {
        ...
        if ($this->end_date !== null || $dt !== null) {
            if ($dt !== $this->end_date) {
                $this->end_date = $dt;
                $this->modifiedColumns[CampaignHistoryTableMap::COL_END_DATE] = true;
            }
        } // if either are not null
    ...
    public function setTimeBeg($v)
    {
        ...
        if ($this->time_beg !== null || $dt !== null) {
            if ($dt !== $this->time_beg) {
                $this->time_beg = $dt;
                $this->modifiedColumns[CampaignHistoryTableMap::COL_TIME_BEG] = true;
            }
        } // if either are not null
    ...
    public function setTimeEnd($v)
    {
        ...
        if ($this->time_end !== null || $dt !== null) {
            if ($dt !== $this->time_end) {
                $this->time_end = $dt;
                $this->modifiedColumns[CampaignHistoryTableMap::COL_TIME_END] = true;
            }
        } // if either are not null
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[CampaignHistoryTableMap::COL_UPDATE_USER] = true;
        }
    ...
    {
            if ($this->start_date && $this->start_date->format('Y-m-d') !== '1000-01-01') {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CampaignHistoryTableMap::translateFieldName('CampaignId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->campaign_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CampaignHistoryTableMap::translateFieldName('CreditCardId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->credit_card_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CampaignHistoryTableMap::translateFieldName('CampaignName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->campaign_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CampaignHistoryTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CampaignHistoryTableMap::translateFieldName('MaxPoints', TableMap::TYPE_PHPNAME, $indexType)];
            $this->max_points = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CampaignHistoryTableMap::translateFieldName('ValueInYen', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value_in_yen = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CampaignHistoryTableMap::translateFieldName('StartDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->start_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CampaignHistoryTableMap::translateFieldName('EndDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->end_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CampaignHistoryTableMap::translateFieldName('TimeBeg', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->time_beg = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CampaignHistoryTableMap::translateFieldName('TimeEnd', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->time_end = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : CampaignHistoryTableMap::translateFieldName('UpdateUser', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 11; // 11 = CampaignHistoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CampaignHistory'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCampaignHistoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CampaignHistory::setDeleted()
     * @see CampaignHistory::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCampaignHistoryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CampaignHistoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_CAMPAIGN_ID)) {
            $modifiedColumns[':p' . $index++]  = 'campaign_id';
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_CREDIT_CARD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'credit_card_id';
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_CAMPAIGN_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'campaign_name';
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_MAX_POINTS)) {
            $modifiedColumns[':p' . $index++]  = 'max_points';
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_VALUE_IN_YEN)) {
            $modifiedColumns[':p' . $index++]  = 'value_in_yen';
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_START_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'start_date';
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_END_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'end_date';
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_TIME_BEG)) {
            $modifiedColumns[':p' . $index++]  = 'time_beg';
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_TIME_END)) {
            $modifiedColumns[':p' . $index++]  = 'time_end';
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }

        $sql = sprintf(
            'INSERT INTO campaign_history (%s) VALUES (%s)',
    ...
    {
        $pos = CampaignHistoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CampaignHistory'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CampaignHistory'][$this->hashCode()] = true;
        $keys = CampaignHistoryTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCampaignId(),
            $keys[1] => $this->getCreditCardId(),
            $keys[2] => $this->getCampaignName(),
            $keys[3] => $this->getDescription(),
            $keys[4] => $this->getMaxPoints(),
            $keys[5] => $this->getValueInYen(),
            $keys[6] => $this->getStartDate(),
            $keys[7] => $this->getEndDate(),
            $keys[8] => $this->getTimeBeg(),
            $keys[9] => $this->getTimeEnd(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setCreditCardId($arr[$keys[1]]);
        }
        ...
        if (array_key_exists($keys[8], $arr)) {
            $this->setTimeBeg($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setTimeEnd($arr[$keys[9]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_CAMPAIGN_ID)) {
            $criteria->add(CampaignHistoryTableMap::COL_CAMPAIGN_ID, $this->campaign_id);
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_CREDIT_CARD_ID)) {
            $criteria->add(CampaignHistoryTableMap::COL_CREDIT_CARD_ID, $this->credit_card_id);
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_CAMPAIGN_NAME)) {
            $criteria->add(CampaignHistoryTableMap::COL_CAMPAIGN_NAME, $this->campaign_name);
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_DESCRIPTION)) {
            $criteria->add(CampaignHistoryTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_MAX_POINTS)) {
            $criteria->add(CampaignHistoryTableMap::COL_MAX_POINTS, $this->max_points);
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_VALUE_IN_YEN)) {
            $criteria->add(CampaignHistoryTableMap::COL_VALUE_IN_YEN, $this->value_in_yen);
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_START_DATE)) {
            $criteria->add(CampaignHistoryTableMap::COL_START_DATE, $this->start_date);
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_END_DATE)) {
            $criteria->add(CampaignHistoryTableMap::COL_END_DATE, $this->end_date);
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_TIME_BEG)) {
            $criteria->add(CampaignHistoryTableMap::COL_TIME_BEG, $this->time_beg);
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_TIME_END)) {
            $criteria->add(CampaignHistoryTableMap::COL_TIME_END, $this->time_end);
        }
        if ($this->isColumnModified(CampaignHistoryTableMap::COL_UPDATE_USER)) {
            $criteria->add(CampaignHistoryTableMap::COL_UPDATE_USER, $this->update_user);
        }
    ...
    {
        $criteria = ChildCampaignHistoryQuery::create();
        $criteria->add(CampaignHistoryTableMap::COL_CAMPAIGN_ID, $this->campaign_id);
        $criteria->add(CampaignHistoryTableMap::COL_TIME_BEG, $this->time_beg);
    ...
    {
        return (null === $this->getCampaignId()) && (null === $this->getTimeBeg());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CampaignHistory (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CampaignHistory Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CampaignHistoryTableMap::DEFAULT_STRING_FORMAT);
    }
