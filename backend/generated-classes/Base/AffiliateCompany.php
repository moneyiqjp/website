...
abstract class AffiliateCompany implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AffiliateCompanyTableMap';
    ...
    /**
     * Initializes internal state of Base\AffiliateCompany object.
     */
    ...
    /**
     * Compares this with another <code>AffiliateCompany</code> instance.  If
     * <code>obj</code> is an instance of <code>AffiliateCompany</code>, delegates to
     * <code>equals(AffiliateCompany)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AffiliateCompany The current object, for fluid interface
     */
    ...
    public function setAffiliateId($v)
    {
        ...
        if ($this->affiliate_id !== $v) {
            $this->affiliate_id = $v;
            $this->modifiedColumns[AffiliateCompanyTableMap::COL_AFFILIATE_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[AffiliateCompanyTableMap::COL_NAME] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[AffiliateCompanyTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setWebsite($v)
    {
        ...
        if ($this->website !== $v) {
            $this->website = $v;
            $this->modifiedColumns[AffiliateCompanyTableMap::COL_WEBSITE] = true;
        }
    ...
    public function setSignedUpDate($v)
    {
        ...
        if ($this->signed_up_date !== null || $dt !== null) {
            if ($dt !== $this->signed_up_date) {
                ...
                $this->modifiedColumns[AffiliateCompanyTableMap::COL_SIGNED_UP_DATE] = true;
            }
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            if ($dt !== $this->update_time) {
                $this->update_time = $dt;
                $this->modifiedColumns[AffiliateCompanyTableMap::COL_UPDATE_TIME] = true;
            }
        } // if either are not null
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[AffiliateCompanyTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AffiliateCompanyTableMap::translateFieldName('AffiliateId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->affiliate_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AffiliateCompanyTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AffiliateCompanyTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AffiliateCompanyTableMap::translateFieldName('Website', TableMap::TYPE_PHPNAME, $indexType)];
            $this->website = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AffiliateCompanyTableMap::translateFieldName('SignedUpDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->signed_up_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AffiliateCompanyTableMap::translateFieldName('UpdateTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->update_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AffiliateCompanyTableMap::translateFieldName('UpdateUser', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = AffiliateCompanyTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\AffiliateCompany'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAffiliateCompanyQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AffiliateCompany::setDeleted()
     * @see AffiliateCompany::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAffiliateCompanyQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AffiliateCompanyTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[AffiliateCompanyTableMap::COL_AFFILIATE_ID] = true;
        if (null !== $this->affiliate_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . AffiliateCompanyTableMap::COL_AFFILIATE_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(AffiliateCompanyTableMap::COL_AFFILIATE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'affiliate_id';
        }
        if ($this->isColumnModified(AffiliateCompanyTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(AffiliateCompanyTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(AffiliateCompanyTableMap::COL_WEBSITE)) {
            $modifiedColumns[':p' . $index++]  = 'website';
        }
        if ($this->isColumnModified(AffiliateCompanyTableMap::COL_SIGNED_UP_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'signed_up_date';
        }
        if ($this->isColumnModified(AffiliateCompanyTableMap::COL_UPDATE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'update_time';
        }
        if ($this->isColumnModified(AffiliateCompanyTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }

        $sql = sprintf(
            'INSERT INTO affiliate_company (%s) VALUES (%s)',
    ...
    {
        $pos = AffiliateCompanyTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['AffiliateCompany'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AffiliateCompany'][$this->hashCode()] = true;
        $keys = AffiliateCompanyTableMap::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(AffiliateCompanyTableMap::DATABASE_NAME);

        if ($this->isColumnModified(AffiliateCompanyTableMap::COL_AFFILIATE_ID)) {
            $criteria->add(AffiliateCompanyTableMap::COL_AFFILIATE_ID, $this->affiliate_id);
        }
        if ($this->isColumnModified(AffiliateCompanyTableMap::COL_NAME)) {
            $criteria->add(AffiliateCompanyTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(AffiliateCompanyTableMap::COL_DESCRIPTION)) {
            $criteria->add(AffiliateCompanyTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(AffiliateCompanyTableMap::COL_WEBSITE)) {
            $criteria->add(AffiliateCompanyTableMap::COL_WEBSITE, $this->website);
        }
        if ($this->isColumnModified(AffiliateCompanyTableMap::COL_SIGNED_UP_DATE)) {
            $criteria->add(AffiliateCompanyTableMap::COL_SIGNED_UP_DATE, $this->signed_up_date);
        }
        if ($this->isColumnModified(AffiliateCompanyTableMap::COL_UPDATE_TIME)) {
            $criteria->add(AffiliateCompanyTableMap::COL_UPDATE_TIME, $this->update_time);
        }
        if ($this->isColumnModified(AffiliateCompanyTableMap::COL_UPDATE_USER)) {
            $criteria->add(AffiliateCompanyTableMap::COL_UPDATE_USER, $this->update_user);
        }
    ...
    {
        $criteria = ChildAffiliateCompanyQuery::create();
        $criteria->add(AffiliateCompanyTableMap::COL_AFFILIATE_ID, $this->affiliate_id);
    ...
    /**
     * Generic method to set the primary key (affiliate_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \AffiliateCompany (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setAffiliateId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \AffiliateCompany Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildAffiliateCompany is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildAffiliateCompany The current object (for fluent API support)
     */
    public function setCreditCards(Collection $creditCards, ConnectionInterface $con = null)
    {
        ...
        foreach ($creditCardsToDelete as $creditCardRemoved) {
            $creditCardRemoved->setAffiliateCompany(null);
        }
    ...
    protected function doAddCreditCard(ChildCreditCard $creditCard)
    {
        ...
        $creditCard->setAffiliateCompany($this);
    }
    ...
    public function removeCreditCard(ChildCreditCard $creditCard)
    {
        if ($this->getCreditCards()->contains($creditCard)) {
            ...
            $creditCard->setAffiliateCompany(null);
        }
     ...
     * Otherwise if this AffiliateCompany is new, it will return
     * an empty collection; or if this AffiliateCompany has previously
     * been saved, it will retrieve related CreditCards from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in AffiliateCompany.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildCreditCard[] List of ChildCreditCard objects
     */
    public function getCreditCardsJoinIssuer(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCreditCardQuery::create(null, $criteria);
        $query->joinWith('Issuer', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(AffiliateCompanyTableMap::DEFAULT_STRING_FORMAT);
    }
