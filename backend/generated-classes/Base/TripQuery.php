 ...
 *
 * @method     ChildTripQuery leftJoinZoneTripMap($relationAlias = null) Adds a LEFT JOIN clause to the query using the ZoneTripMap relation
 * @method     ChildTripQuery rightJoinZoneTripMap($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ZoneTripMap relation
 * @method     ChildTripQuery innerJoinZoneTripMap($relationAlias = null) Adds a INNER JOIN clause to the query using the ZoneTripMap relation
 *
 * @method     \UnitQuery|\CityQuery|\FlightCostQuery|\MileageQuery|\ZoneTripMapQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class TripQuery extends ModelCriteria
{
    ...
    public function filterByZoneTripMap($zoneTripMap, $comparison = null)
    {
        if ($zoneTripMap instanceof \ZoneTripMap) {
            return $this
                ->addUsingAlias(TripTableMap::COL_TRIP_ID, $zoneTripMap->getTripId(), $comparison);
