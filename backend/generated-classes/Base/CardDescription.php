...
abstract class CardDescription implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CardDescriptionTableMap';
    ...
    /**
     * Initializes internal state of Base\CardDescription object.
     */
    ...
    /**
     * Compares this with another <code>CardDescription</code> instance.  If
     * <code>obj</code> is an instance of <code>CardDescription</code>, delegates to
     * <code>equals(CardDescription)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CardDescription The current object, for fluid interface
     */
    ...
    public function setItemId($v)
    {
        ...
        if ($this->item_id !== $v) {
            $this->item_id = $v;
            $this->modifiedColumns[CardDescriptionTableMap::COL_ITEM_ID] = true;
        }
    ...
    public function setCreditCardId($v)
    {
        ...
        if ($this->credit_card_id !== $v) {
            ...
            $this->modifiedColumns[CardDescriptionTableMap::COL_CREDIT_CARD_ID] = true;
        }
    ...
    public function setItemName($v)
    {
        ...
        if ($this->item_name !== $v) {
            $this->item_name = $v;
            $this->modifiedColumns[CardDescriptionTableMap::COL_ITEM_NAME] = true;
        }
    ...
    public function setItemDescription($v)
    {
        ...
        if ($this->item_description !== $v) {
            ...
            $this->modifiedColumns[CardDescriptionTableMap::COL_ITEM_DESCRIPTION] = true;
        }
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            if ($dt !== $this->update_time) {
                $this->update_time = $dt;
                $this->modifiedColumns[CardDescriptionTableMap::COL_UPDATE_TIME] = true;
            }
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[CardDescriptionTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CardDescriptionTableMap::translateFieldName('ItemId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->item_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CardDescriptionTableMap::translateFieldName('CreditCardId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCardDescriptionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CardDescription::setDeleted()
     * @see CardDescription::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCardDescriptionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CardDescriptionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CardDescriptionTableMap::COL_ITEM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'item_id';
        }
        if ($this->isColumnModified(CardDescriptionTableMap::COL_CREDIT_CARD_ID)) {
        ...
        if ($this->isColumnModified(CardDescriptionTableMap::COL_UPDATE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'update_time';
        }
        if ($this->isColumnModified(CardDescriptionTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }

        $sql = sprintf(
            'INSERT INTO card_description (%s) VALUES (%s)',
    ...
    {
        $pos = CardDescriptionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CardDescription'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CardDescription'][$this->hashCode()] = true;
        $keys = CardDescriptionTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CardDescriptionTableMap::COL_ITEM_ID)) {
            $criteria->add(CardDescriptionTableMap::COL_ITEM_ID, $this->item_id);
        }
        if ($this->isColumnModified(CardDescriptionTableMap::COL_CREDIT_CARD_ID)) {
            $criteria->add(CardDescriptionTableMap::COL_CREDIT_CARD_ID, $this->credit_card_id);
        }
        if ($this->isColumnModified(CardDescriptionTableMap::COL_ITEM_NAME)) {
        ...
        if ($this->isColumnModified(CardDescriptionTableMap::COL_UPDATE_TIME)) {
            $criteria->add(CardDescriptionTableMap::COL_UPDATE_TIME, $this->update_time);
        }
        if ($this->isColumnModified(CardDescriptionTableMap::COL_UPDATE_USER)) {
            $criteria->add(CardDescriptionTableMap::COL_UPDATE_USER, $this->update_user);
        }
    ...
    {
        $criteria = ChildCardDescriptionQuery::create();
        $criteria->add(CardDescriptionTableMap::COL_ITEM_ID, $this->item_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CardDescription (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CardDescription Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCreditCard(ConnectionInterface $con = null)
    {
        if ($this->aCreditCard === null && ($this->credit_card_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCreditCard->addCardDescriptions($this);
             */
        }
    ...
    {
        if (null !== $this->aCreditCard) {
            $this->aCreditCard->removeCardDescription($this);
        }
        $this->item_id = null;
    ...
    {
        return (string) $this->exportTo(CardDescriptionTableMap::DEFAULT_STRING_FORMAT);
    }
