...
abstract class PersonaRestriction implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PersonaRestrictionTableMap';
    ...
    /**
     * Initializes internal state of Base\PersonaRestriction object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>PersonaRestriction</code> instance.  If
     * <code>obj</code> is an instance of <code>PersonaRestriction</code>, delegates to
     * <code>equals(PersonaRestriction)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PersonaRestriction The current object, for fluid interface
     */
    ...
    public function setPersonaId($v)
    {
        ...
        if ($this->persona_id !== $v) {
            $this->persona_id = $v;
            $this->modifiedColumns[PersonaRestrictionTableMap::COL_PERSONA_ID] = true;
        }
    ...
    public function setRestrictionTypeId($v)
    {
        ...
        if ($this->restriction_type_id !== $v) {
            ...
            $this->modifiedColumns[PersonaRestrictionTableMap::COL_RESTRICTION_TYPE_ID] = true;
        }
    ...
    public function setComparator($v)
    {
        ...
        if ($this->comparator !== $v) {
            $this->comparator = $v;
            $this->modifiedColumns[PersonaRestrictionTableMap::COL_COMPARATOR] = true;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[PersonaRestrictionTableMap::COL_VALUE] = true;
        }
    ...
    public function setPriorityId($v)
    {
        ...
        if ($this->priority_id !== $v) {
            $this->priority_id = $v;
            $this->modifiedColumns[PersonaRestrictionTableMap::COL_PRIORITY_ID] = true;
        }
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            if ($dt !== $this->update_time) {
                $this->update_time = $dt;
                $this->modifiedColumns[PersonaRestrictionTableMap::COL_UPDATE_TIME] = true;
            }
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[PersonaRestrictionTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PersonaRestrictionTableMap::translateFieldName('PersonaId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->persona_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PersonaRestrictionTableMap::translateFieldName('RestrictionTypeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->restriction_type_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PersonaRestrictionTableMap::translateFieldName('Comparator', TableMap::TYPE_PHPNAME, $indexType)];
            $this->comparator = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PersonaRestrictionTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PersonaRestrictionTableMap::translateFieldName('PriorityId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priority_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PersonaRestrictionTableMap::translateFieldName('UpdateTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->update_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : PersonaRestrictionTableMap::translateFieldName('UpdateUser', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = PersonaRestrictionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PersonaRestriction'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPersonaRestrictionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PersonaRestriction::setDeleted()
     * @see PersonaRestriction::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPersonaRestrictionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PersonaRestrictionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PersonaRestrictionTableMap::COL_PERSONA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'persona_id';
        }
        if ($this->isColumnModified(PersonaRestrictionTableMap::COL_RESTRICTION_TYPE_ID)) {
        ...
        if ($this->isColumnModified(PersonaRestrictionTableMap::COL_PRIORITY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'priority_id';
        }
        if ($this->isColumnModified(PersonaRestrictionTableMap::COL_UPDATE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'update_time';
        }
        if ($this->isColumnModified(PersonaRestrictionTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }

        $sql = sprintf(
            'INSERT INTO persona_restriction (%s) VALUES (%s)',
    ...
    {
        $pos = PersonaRestrictionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PersonaRestriction'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PersonaRestriction'][$this->hashCode()] = true;
        $keys = PersonaRestrictionTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PersonaRestriction
     */
    ...
    {
        $criteria = new Criteria(PersonaRestrictionTableMap::DATABASE_NAME);

        if ($this->isColumnModified(PersonaRestrictionTableMap::COL_PERSONA_ID)) {
            $criteria->add(PersonaRestrictionTableMap::COL_PERSONA_ID, $this->persona_id);
        }
        if ($this->isColumnModified(PersonaRestrictionTableMap::COL_RESTRICTION_TYPE_ID)) {
            $criteria->add(PersonaRestrictionTableMap::COL_RESTRICTION_TYPE_ID, $this->restriction_type_id);
        }
        if ($this->isColumnModified(PersonaRestrictionTableMap::COL_COMPARATOR)) {
            $criteria->add(PersonaRestrictionTableMap::COL_COMPARATOR, $this->comparator);
        }
        if ($this->isColumnModified(PersonaRestrictionTableMap::COL_VALUE)) {
            $criteria->add(PersonaRestrictionTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(PersonaRestrictionTableMap::COL_PRIORITY_ID)) {
            $criteria->add(PersonaRestrictionTableMap::COL_PRIORITY_ID, $this->priority_id);
        }
        if ($this->isColumnModified(PersonaRestrictionTableMap::COL_UPDATE_TIME)) {
            $criteria->add(PersonaRestrictionTableMap::COL_UPDATE_TIME, $this->update_time);
        }
        if ($this->isColumnModified(PersonaRestrictionTableMap::COL_UPDATE_USER)) {
            $criteria->add(PersonaRestrictionTableMap::COL_UPDATE_USER, $this->update_user);
        }
    ...
    {
        $criteria = ChildPersonaRestrictionQuery::create();
        $criteria->add(PersonaRestrictionTableMap::COL_PERSONA_ID, $this->persona_id);
        $criteria->add(PersonaRestrictionTableMap::COL_RESTRICTION_TYPE_ID, $this->restriction_type_id);
    ...
    public function hashCode()
    {
        ...
        //relation FK_pr_persona_id to table persona
        ...
        //relation FK_pr_restriction_type_id to table restriction_type
    ...
    {
        return (null === $this->getPersonaId()) && (null === $this->getRestrictionTypeId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PersonaRestriction (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PersonaRestriction Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPersona(ConnectionInterface $con = null)
    {
        if ($this->aPersona === null && ($this->persona_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPersona->addPersonaRestrictions($this);
             */
        }
    ...
    public function getRestrictionType(ConnectionInterface $con = null)
    {
        if ($this->aRestrictionType === null && ($this->restriction_type_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRestrictionType->addPersonaRestrictions($this);
             */
        }
    ...
    {
        if (null !== $this->aPersona) {
            $this->aPersona->removePersonaRestriction($this);
        }
        if (null !== $this->aRestrictionType) {
            $this->aRestrictionType->removePersonaRestriction($this);
        }
    ...
    {
        return (string) $this->exportTo(PersonaRestrictionTableMap::DEFAULT_STRING_FORMAT);
    }
