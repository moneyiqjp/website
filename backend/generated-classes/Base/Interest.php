...
abstract class Interest implements ActiveRecordInterface
{
    ...
    public function setCreditCardId($v)
    {
        ...
        if ($this->credit_card_id !== $v) {
            ...
            $this->modifiedColumns[InterestTableMap::COL_CREDIT_CARD_ID] = true;
        }
    ...
    public function setPaymentTypeId($v)
    {
        ...
        if ($this->payment_type_id !== $v) {
            ...
            $this->modifiedColumns[InterestTableMap::COL_PAYMENT_TYPE_ID] = true;
        }
    ...
    public function setMinInterest($v)
    {
        ...
        if ($this->min_interest !== $v) {
            $this->min_interest = $v;
            $this->modifiedColumns[InterestTableMap::COL_MIN_INTEREST] = true;
        }
    ...
    public function setMaxInterest($v)
    {
        ...
        if ($this->max_interest !== $v) {
            $this->max_interest = $v;
            $this->modifiedColumns[InterestTableMap::COL_MAX_INTEREST] = true;
        }
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            if ($dt !== $this->update_time) {
                $this->update_time = $dt;
                $this->modifiedColumns[InterestTableMap::COL_UPDATE_TIME] = true;
            }
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[InterestTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function setReference($v)
    {
        ...
        if ($this->reference !== $v) {
            $this->reference = $v;
            $this->modifiedColumns[InterestTableMap::COL_REFERENCE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InterestTableMap::translateFieldName('CreditCardId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->credit_card_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : InterestTableMap::translateFieldName('PaymentTypeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payment_type_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : InterestTableMap::translateFieldName('MinInterest', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPaymentType !== null && $this->payment_type_id !== $this->aPaymentType->getPaymentTypeId()) {
            $this->aPaymentType = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InterestTableMap::COL_CREDIT_CARD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'credit_card_id';
        }
        if ($this->isColumnModified(InterestTableMap::COL_PAYMENT_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'payment_type_id';
        }
        if ($this->isColumnModified(InterestTableMap::COL_MIN_INTEREST)) {
        ...
        if ($this->isColumnModified(InterestTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }
        if ($this->isColumnModified(InterestTableMap::COL_REFERENCE)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Interest'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Interest'][$this->hashCode()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InterestTableMap::COL_CREDIT_CARD_ID)) {
            $criteria->add(InterestTableMap::COL_CREDIT_CARD_ID, $this->credit_card_id);
        }
        if ($this->isColumnModified(InterestTableMap::COL_PAYMENT_TYPE_ID)) {
            $criteria->add(InterestTableMap::COL_PAYMENT_TYPE_ID, $this->payment_type_id);
        }
        if ($this->isColumnModified(InterestTableMap::COL_MIN_INTEREST)) {
            $criteria->add(InterestTableMap::COL_MIN_INTEREST, $this->min_interest);
        }
        if ($this->isColumnModified(InterestTableMap::COL_MAX_INTEREST)) {
        ...
        if ($this->isColumnModified(InterestTableMap::COL_UPDATE_USER)) {
            $criteria->add(InterestTableMap::COL_UPDATE_USER, $this->update_user);
        }
        if ($this->isColumnModified(InterestTableMap::COL_REFERENCE)) {
            $criteria->add(InterestTableMap::COL_REFERENCE, $this->reference);
        }
    ...
    {
        $criteria = ChildInterestQuery::create();
        $criteria->add(InterestTableMap::COL_INTEREST_ID, $this->interest_id);
    ...
    public function getCreditCard(ConnectionInterface $con = null)
    {
        if ($this->aCreditCard === null && ($this->credit_card_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCreditCard->addInterests($this);
             */
        }
