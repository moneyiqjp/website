...
/**
 * Base class that represents a row from the 'insurance' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Insurance implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InsuranceTableMap';
    ...
    /**
     * Initializes internal state of Base\Insurance object.
     */
    ...
    /**
     * Compares this with another <code>Insurance</code> instance.  If
     * <code>obj</code> is an instance of <code>Insurance</code>, delegates to
     * <code>equals(Insurance)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Insurance The current object, for fluid interface
     */
    ...
    public function setInsuranceId($v)
    {
        ...
        if ($this->insurance_id !== $v) {
            $this->insurance_id = $v;
            $this->modifiedColumns[InsuranceTableMap::COL_INSURANCE_ID] = true;
        }
    ...
    public function setCreditCardId($v)
    {
        ...
        if ($this->credit_card_id !== $v) {
            ...
            $this->modifiedColumns[InsuranceTableMap::COL_CREDIT_CARD_ID] = true;
        }
    ...
    public function setInsuranceTypeId($v)
    {
        ...
        if ($this->insurance_type_id !== $v) {
            ...
            $this->modifiedColumns[InsuranceTableMap::COL_INSURANCE_TYPE_ID] = true;
        }

        if ($this->aInsuranceType !== null && $this->aInsuranceType->getInsuranceTypeId() !== $v) {
    ...
    public function setMaxInsuredAmount($v)
    {
        ...
        if ($this->max_insured_amount !== $v) {
            ...
            $this->modifiedColumns[InsuranceTableMap::COL_MAX_INSURED_AMOUNT] = true;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[InsuranceTableMap::COL_VALUE] = true;
        }
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            if ($dt !== $this->update_time) {
                $this->update_time = $dt;
                $this->modifiedColumns[InsuranceTableMap::COL_UPDATE_TIME] = true;
            }
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[InsuranceTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InsuranceTableMap::translateFieldName('InsuranceId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->insurance_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InsuranceTableMap::translateFieldName('CreditCardId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aInsuranceType !== null && $this->insurance_type_id !== $this->aInsuranceType->getInsuranceTypeId()) {
            $this->aInsuranceType = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildInsuranceQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Insurance::setDeleted()
     * @see Insurance::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildInsuranceQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InsuranceTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InsuranceTableMap::COL_INSURANCE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'insurance_id';
        }
        if ($this->isColumnModified(InsuranceTableMap::COL_CREDIT_CARD_ID)) {
        ...
        if ($this->isColumnModified(InsuranceTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(InsuranceTableMap::COL_UPDATE_TIME)) {
    ...
    {
        $pos = InsuranceTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Insurance'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Insurance'][$this->hashCode()] = true;
        $keys = InsuranceTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InsuranceTableMap::COL_INSURANCE_ID)) {
            $criteria->add(InsuranceTableMap::COL_INSURANCE_ID, $this->insurance_id);
        }
        if ($this->isColumnModified(InsuranceTableMap::COL_CREDIT_CARD_ID)) {
            $criteria->add(InsuranceTableMap::COL_CREDIT_CARD_ID, $this->credit_card_id);
        }
        if ($this->isColumnModified(InsuranceTableMap::COL_INSURANCE_TYPE_ID)) {
        ...
        if ($this->isColumnModified(InsuranceTableMap::COL_VALUE)) {
            $criteria->add(InsuranceTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(InsuranceTableMap::COL_UPDATE_TIME)) {
            $criteria->add(InsuranceTableMap::COL_UPDATE_TIME, $this->update_time);
        }
        if ($this->isColumnModified(InsuranceTableMap::COL_UPDATE_USER)) {
    ...
    {
        $criteria = ChildInsuranceQuery::create();
        $criteria->add(InsuranceTableMap::COL_INSURANCE_ID, $this->insurance_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Insurance (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Insurance Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCreditCard(ConnectionInterface $con = null)
    {
        if ($this->aCreditCard === null && ($this->credit_card_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCreditCard->addInsurances($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(InsuranceTableMap::DEFAULT_STRING_FORMAT);
    }
