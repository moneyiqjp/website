...
abstract class CardPointSystem implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CardPointSystemTableMap';
    ...
    /**
     * The value for the card_point_system_id field.
     * @var        int
     */
    protected $card_point_system_id;
    ...
    /**
     * Initializes internal state of Base\CardPointSystem object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CardPointSystem</code> instance.  If
     * <code>obj</code> is an instance of <code>CardPointSystem</code>, delegates to
     * <code>equals(CardPointSystem)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CardPointSystem The current object, for fluid interface
     */
    ...
    {
        return $this->card_point_system_id;
    }
     ...
     */
    public function setCardPointSystemId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->card_point_system_id !== $v) {
            $this->card_point_system_id = $v;
            $this->modifiedColumns[CardPointSystemTableMap::COL_CARD_POINT_SYSTEM_ID] = true;
        }

        return $this;
    } // setCardPointSystemId()
    ...
    public function setCreditCardId($v)
    {
        ...
        if ($this->credit_card_id !== $v) {
            ...
            $this->modifiedColumns[CardPointSystemTableMap::COL_CREDIT_CARD_ID] = true;
        }
    ...
    public function setPointSystemId($v)
    {
        ...
        if ($this->point_system_id !== $v) {
            ...
            $this->modifiedColumns[CardPointSystemTableMap::COL_POINT_SYSTEM_ID] = true;
        }
    ...
    public function setPriorityId($v)
    {
        ...
        if ($this->priority_id !== $v) {
            $this->priority_id = $v;
            $this->modifiedColumns[CardPointSystemTableMap::COL_PRIORITY_ID] = true;
        }
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            if ($dt !== $this->update_time) {
                $this->update_time = $dt;
                $this->modifiedColumns[CardPointSystemTableMap::COL_UPDATE_TIME] = true;
            }
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[CardPointSystemTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CardPointSystemTableMap::translateFieldName('CardPointSystemId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->card_point_system_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CardPointSystemTableMap::translateFieldName('CreditCardId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->credit_card_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CardPointSystemTableMap::translateFieldName('PointSystemId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->point_system_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CardPointSystemTableMap::translateFieldName('PriorityId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priority_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CardPointSystemTableMap::translateFieldName('UpdateTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->update_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CardPointSystemTableMap::translateFieldName('UpdateUser', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = CardPointSystemTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CardPointSystem'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCardPointSystemQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CardPointSystem::setDeleted()
     * @see CardPointSystem::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCardPointSystemQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CardPointSystemTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[CardPointSystemTableMap::COL_CARD_POINT_SYSTEM_ID] = true;
        if (null !== $this->card_point_system_id) {
        ...
        if ($this->isColumnModified(CardPointSystemTableMap::COL_CARD_POINT_SYSTEM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'card_point_system_id';
        }
        if ($this->isColumnModified(CardPointSystemTableMap::COL_CREDIT_CARD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'credit_card_id';
        }
        if ($this->isColumnModified(CardPointSystemTableMap::COL_POINT_SYSTEM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'point_system_id';
        }
        if ($this->isColumnModified(CardPointSystemTableMap::COL_PRIORITY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'priority_id';
        }
        if ($this->isColumnModified(CardPointSystemTableMap::COL_UPDATE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'update_time';
        }
        if ($this->isColumnModified(CardPointSystemTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }

        $sql = sprintf(
            'INSERT INTO card_point_system (%s) VALUES (%s)',
    ...
    {
        $pos = CardPointSystemTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getCardPointSystemId();
                break;
            case 1:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CardPointSystem'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CardPointSystem'][$this->hashCode()] = true;
        $keys = CardPointSystemTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCardPointSystemId(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setCardPointSystemId($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setCardPointSystemId($arr[$keys[0]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CardPointSystemTableMap::COL_CARD_POINT_SYSTEM_ID)) {
            $criteria->add(CardPointSystemTableMap::COL_CARD_POINT_SYSTEM_ID, $this->card_point_system_id);
        }
        if ($this->isColumnModified(CardPointSystemTableMap::COL_CREDIT_CARD_ID)) {
            $criteria->add(CardPointSystemTableMap::COL_CREDIT_CARD_ID, $this->credit_card_id);
        }
        if ($this->isColumnModified(CardPointSystemTableMap::COL_POINT_SYSTEM_ID)) {
            $criteria->add(CardPointSystemTableMap::COL_POINT_SYSTEM_ID, $this->point_system_id);
        }
        if ($this->isColumnModified(CardPointSystemTableMap::COL_PRIORITY_ID)) {
            $criteria->add(CardPointSystemTableMap::COL_PRIORITY_ID, $this->priority_id);
        }
        if ($this->isColumnModified(CardPointSystemTableMap::COL_UPDATE_TIME)) {
            $criteria->add(CardPointSystemTableMap::COL_UPDATE_TIME, $this->update_time);
        }
        if ($this->isColumnModified(CardPointSystemTableMap::COL_UPDATE_USER)) {
            $criteria->add(CardPointSystemTableMap::COL_UPDATE_USER, $this->update_user);
        }
    ...
    {
        $criteria = ChildCardPointSystemQuery::create();
        $criteria->add(CardPointSystemTableMap::COL_CARD_POINT_SYSTEM_ID, $this->card_point_system_id);
    ...
    {
        $validPk = null !== $this->getCardPointSystemId();
    ...
    /**
     * Generic method to set the primary key (card_point_system_id column).
     *
    ...
    {
        return null === $this->getCardPointSystemId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CardPointSystem (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setCardPointSystemId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CardPointSystem Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCreditCard(ConnectionInterface $con = null)
    {
        if ($this->aCreditCard === null && ($this->credit_card_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCreditCard->addCardPointSystems($this);
             */
        }
    ...
    public function getPointSystem(ConnectionInterface $con = null)
    {
        if ($this->aPointSystem === null && ($this->point_system_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPointSystem->addCardPointSystems($this);
             */
        }
    ...
    {
        if (null !== $this->aCreditCard) {
            $this->aCreditCard->removeCardPointSystem($this);
        }
        if (null !== $this->aPointSystem) {
            $this->aPointSystem->removeCardPointSystem($this);
        }
        $this->card_point_system_id = null;
    ...
    {
        return (string) $this->exportTo(CardPointSystemTableMap::DEFAULT_STRING_FORMAT);
    }
