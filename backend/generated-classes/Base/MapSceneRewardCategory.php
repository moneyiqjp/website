...
/**
 * Base class that represents a row from the 'map_scene_reward_category' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class MapSceneRewardCategory implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MapSceneRewardCategoryTableMap';
    ...
    /**
     * Initializes internal state of Base\MapSceneRewardCategory object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>MapSceneRewardCategory</code> instance.  If
     * <code>obj</code> is an instance of <code>MapSceneRewardCategory</code>, delegates to
     * <code>equals(MapSceneRewardCategory)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MapSceneRewardCategory The current object, for fluid interface
     */
     ...
     * @return $this|\MapSceneRewardCategory The current object (for fluent API support)
     */
    public function setSceneId($v)
    {
        ...
        if ($this->scene_id !== $v) {
            $this->scene_id = $v;
            $this->modifiedColumns[MapSceneRewardCategoryTableMap::COL_SCENE_ID] = true;
        }
    ...
    public function setRewardCategoryId($v)
    {
        ...
        if ($this->reward_category_id !== $v) {
            ...
            $this->modifiedColumns[MapSceneRewardCategoryTableMap::COL_REWARD_CATEGORY_ID] = true;
        }
    ...
    public function setPriorityId($v)
    {
        ...
        if ($this->priority_id !== $v) {
            $this->priority_id = $v;
            $this->modifiedColumns[MapSceneRewardCategoryTableMap::COL_PRIORITY_ID] = true;
        }
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            if ($dt !== $this->update_time) {
                $this->update_time = $dt;
                $this->modifiedColumns[MapSceneRewardCategoryTableMap::COL_UPDATE_TIME] = true;
            }
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[MapSceneRewardCategoryTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MapSceneRewardCategoryTableMap::translateFieldName('SceneId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->scene_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MapSceneRewardCategoryTableMap::translateFieldName('RewardCategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->reward_category_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MapSceneRewardCategoryTableMap::translateFieldName('PriorityId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priority_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MapSceneRewardCategoryTableMap::translateFieldName('UpdateTime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->update_time = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MapSceneRewardCategoryTableMap::translateFieldName('UpdateUser', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = MapSceneRewardCategoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MapSceneRewardCategory'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMapSceneRewardCategoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MapSceneRewardCategory::setDeleted()
     * @see MapSceneRewardCategory::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMapSceneRewardCategoryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MapSceneRewardCategoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MapSceneRewardCategoryTableMap::COL_SCENE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'scene_id';
        }
        if ($this->isColumnModified(MapSceneRewardCategoryTableMap::COL_REWARD_CATEGORY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'reward_category_id';
        }
        if ($this->isColumnModified(MapSceneRewardCategoryTableMap::COL_PRIORITY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'priority_id';
        }
        if ($this->isColumnModified(MapSceneRewardCategoryTableMap::COL_UPDATE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'update_time';
        }
        if ($this->isColumnModified(MapSceneRewardCategoryTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }

        $sql = sprintf(
            'INSERT INTO map_scene_reward_category (%s) VALUES (%s)',
    ...
    {
        $pos = MapSceneRewardCategoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MapSceneRewardCategory'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MapSceneRewardCategory'][$this->hashCode()] = true;
        $keys = MapSceneRewardCategoryTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\MapSceneRewardCategory
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MapSceneRewardCategoryTableMap::COL_SCENE_ID)) {
            $criteria->add(MapSceneRewardCategoryTableMap::COL_SCENE_ID, $this->scene_id);
        }
        if ($this->isColumnModified(MapSceneRewardCategoryTableMap::COL_REWARD_CATEGORY_ID)) {
            $criteria->add(MapSceneRewardCategoryTableMap::COL_REWARD_CATEGORY_ID, $this->reward_category_id);
        }
        if ($this->isColumnModified(MapSceneRewardCategoryTableMap::COL_PRIORITY_ID)) {
            $criteria->add(MapSceneRewardCategoryTableMap::COL_PRIORITY_ID, $this->priority_id);
        }
        if ($this->isColumnModified(MapSceneRewardCategoryTableMap::COL_UPDATE_TIME)) {
            $criteria->add(MapSceneRewardCategoryTableMap::COL_UPDATE_TIME, $this->update_time);
        }
        if ($this->isColumnModified(MapSceneRewardCategoryTableMap::COL_UPDATE_USER)) {
            $criteria->add(MapSceneRewardCategoryTableMap::COL_UPDATE_USER, $this->update_user);
        }
    ...
    {
        $criteria = ChildMapSceneRewardCategoryQuery::create();
        $criteria->add(MapSceneRewardCategoryTableMap::COL_SCENE_ID, $this->scene_id);
        $criteria->add(MapSceneRewardCategoryTableMap::COL_REWARD_CATEGORY_ID, $this->reward_category_id);
    ...
    public function hashCode()
    {
        ...
        //relation FK_msrc_map_scene_reward_reward_category to table reward_category
        ...
        //relation FK_msrc_map_scene_reward_scene to table scene
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MapSceneRewardCategory (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MapSceneRewardCategory Clone of current object.
     * @throws PropelException
     */
    ...
    public function setRewardCategory(ChildRewardCategory $v = null)
    {
        ...
        if ($v !== null) {
            $v->addMapSceneRewardCategory($this);
        }
    ...
    public function getRewardCategory(ConnectionInterface $con = null)
    {
        if ($this->aRewardCategory === null && ($this->reward_category_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aRewardCategory->addMapSceneRewardCategories($this);
             */
        }
    ...
    public function getScene(ConnectionInterface $con = null)
    {
        if ($this->aScene === null && ($this->scene_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aScene->addMapSceneRewardCategories($this);
             */
        }
    ...
    {
        if (null !== $this->aRewardCategory) {
            $this->aRewardCategory->removeMapSceneRewardCategory($this);
        }
        if (null !== $this->aScene) {
            $this->aScene->removeMapSceneRewardCategory($this);
        }
        $this->scene_id = null;
    ...
    {
        return (string) $this->exportTo(MapSceneRewardCategoryTableMap::DEFAULT_STRING_FORMAT);
    }
