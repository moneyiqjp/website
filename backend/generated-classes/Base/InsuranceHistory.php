...
/**
 * Base class that represents a row from the 'insurance_history' table.
 *
 * 
 *
* @package    propel.generator..Base
*/
abstract class InsuranceHistory implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InsuranceHistoryTableMap';
    ...
    /**
     * Initializes internal state of Base\InsuranceHistory object.
     */
    ...
    /**
     * Compares this with another <code>InsuranceHistory</code> instance.  If
     * <code>obj</code> is an instance of <code>InsuranceHistory</code>, delegates to
     * <code>equals(InsuranceHistory)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|InsuranceHistory The current object, for fluid interface
     */
     ...
     * @return $this|\InsuranceHistory The current object (for fluent API support)
     */
    public function setInsuranceId($v)
    {
        ...
        if ($this->insurance_id !== $v) {
            $this->insurance_id = $v;
            $this->modifiedColumns[InsuranceHistoryTableMap::COL_INSURANCE_ID] = true;
        }
    ...
    public function setCreditCardId($v)
    {
        ...
        if ($this->credit_card_id !== $v) {
            ...
            $this->modifiedColumns[InsuranceHistoryTableMap::COL_CREDIT_CARD_ID] = true;
        }
    ...
    public function setInsuranceTypeId($v)
    {
        ...
        if ($this->insurance_type_id !== $v) {
            ...
            $this->modifiedColumns[InsuranceHistoryTableMap::COL_INSURANCE_TYPE_ID] = true;
        }
     ...
     * @return $this|\InsuranceHistory The current object (for fluent API support)
     */
    public function setMaxInsuredAmount($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->max_insured_amount !== $v) {
            $this->max_insured_amount = $v;
            $this->modifiedColumns[InsuranceHistoryTableMap::COL_MAX_INSURED_AMOUNT] = true;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[InsuranceHistoryTableMap::COL_VALUE] = true;
        }
    ...
    public function setTimeBeg($v)
    {
        ...
        if ($this->time_beg !== null || $dt !== null) {
            if ($dt !== $this->time_beg) {
                $this->time_beg = $dt;
                $this->modifiedColumns[InsuranceHistoryTableMap::COL_TIME_BEG] = true;
            }
    ...
    public function setTimeEnd($v)
    {
        ...
        if ($this->time_end !== null || $dt !== null) {
            if ($dt !== $this->time_end) {
                $this->time_end = $dt;
                $this->modifiedColumns[InsuranceHistoryTableMap::COL_TIME_END] = true;
            }
        } // if either are not null
    ...
    public function setUpdateUser($v)
    {
        ...
        if ($this->update_user !== $v) {
            $this->update_user = $v;
            $this->modifiedColumns[InsuranceHistoryTableMap::COL_UPDATE_USER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InsuranceHistoryTableMap::translateFieldName('InsuranceId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->insurance_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InsuranceHistoryTableMap::translateFieldName('CreditCardId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->credit_card_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : InsuranceHistoryTableMap::translateFieldName('InsuranceTypeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->insurance_type_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : InsuranceHistoryTableMap::translateFieldName('MaxInsuredAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->max_insured_amount = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : InsuranceHistoryTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : InsuranceHistoryTableMap::translateFieldName('TimeBeg', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->time_beg = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : InsuranceHistoryTableMap::translateFieldName('TimeEnd', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->time_end = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : InsuranceHistoryTableMap::translateFieldName('UpdateUser', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = InsuranceHistoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\InsuranceHistory'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildInsuranceHistoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see InsuranceHistory::setDeleted()
     * @see InsuranceHistory::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildInsuranceHistoryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InsuranceHistoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_INSURANCE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'insurance_id';
        }
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_CREDIT_CARD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'credit_card_id';
        }
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_INSURANCE_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'insurance_type_id';
        }
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_MAX_INSURED_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'max_insured_amount';
        }
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_TIME_BEG)) {
            $modifiedColumns[':p' . $index++]  = 'time_beg';
        }
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_TIME_END)) {
            $modifiedColumns[':p' . $index++]  = 'time_end';
        }
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_UPDATE_USER)) {
            $modifiedColumns[':p' . $index++]  = 'update_user';
        }

        $sql = sprintf(
            'INSERT INTO insurance_history (%s) VALUES (%s)',
    ...
    {
        $pos = InsuranceHistoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['InsuranceHistory'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['InsuranceHistory'][$this->hashCode()] = true;
        $keys = InsuranceHistoryTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_INSURANCE_ID)) {
            $criteria->add(InsuranceHistoryTableMap::COL_INSURANCE_ID, $this->insurance_id);
        }
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_CREDIT_CARD_ID)) {
            $criteria->add(InsuranceHistoryTableMap::COL_CREDIT_CARD_ID, $this->credit_card_id);
        }
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_INSURANCE_TYPE_ID)) {
            $criteria->add(InsuranceHistoryTableMap::COL_INSURANCE_TYPE_ID, $this->insurance_type_id);
        }
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_MAX_INSURED_AMOUNT)) {
            $criteria->add(InsuranceHistoryTableMap::COL_MAX_INSURED_AMOUNT, $this->max_insured_amount);
        }
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_VALUE)) {
            $criteria->add(InsuranceHistoryTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_TIME_BEG)) {
            $criteria->add(InsuranceHistoryTableMap::COL_TIME_BEG, $this->time_beg);
        }
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_TIME_END)) {
            $criteria->add(InsuranceHistoryTableMap::COL_TIME_END, $this->time_end);
        }
        if ($this->isColumnModified(InsuranceHistoryTableMap::COL_UPDATE_USER)) {
            $criteria->add(InsuranceHistoryTableMap::COL_UPDATE_USER, $this->update_user);
        }
    ...
    {
        $criteria = ChildInsuranceHistoryQuery::create();
        $criteria->add(InsuranceHistoryTableMap::COL_INSURANCE_ID, $this->insurance_id);
        $criteria->add(InsuranceHistoryTableMap::COL_TIME_BEG, $this->time_beg);
    ...
    {
        return (null === $this->getInsuranceId()) && (null === $this->getTimeBeg());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \InsuranceHistory (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \InsuranceHistory Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(InsuranceHistoryTableMap::DEFAULT_STRING_FORMAT);
    }
