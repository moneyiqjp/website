...
class UnitTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.UnitTableMap';
     ...
     */
    const COL_UNIT_ID = 'unit.unit_id';
     ...
     */
    const COL_DESCRIPTION = 'unit.description';

    /**
     * the column name for the update_time field
     */
    const COL_UPDATE_TIME = 'unit.update_time';

    /**
     * the column name for the update_user field
     */
    const COL_UPDATE_USER = 'unit.update_user';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('UnitId', 'Name', 'Description', 'UpdateTime', 'UpdateUser', ),
        self::TYPE_CAMELNAME     => array('unitId', 'name', 'description', 'updateTime', 'updateUser', ),
        self::TYPE_COLNAME       => array(UnitTableMap::COL_UNIT_ID, UnitTableMap::COL_NAME, UnitTableMap::COL_DESCRIPTION, UnitTableMap::COL_UPDATE_TIME, UnitTableMap::COL_UPDATE_USER, ),
        self::TYPE_FIELDNAME     => array('unit_id', 'name', 'description', 'update_time', 'update_user', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('UnitId' => 0, 'Name' => 1, 'Description' => 2, 'UpdateTime' => 3, 'UpdateUser' => 4, ),
        self::TYPE_CAMELNAME     => array('unitId' => 0, 'name' => 1, 'description' => 2, 'updateTime' => 3, 'updateUser' => 4, ),
        self::TYPE_COLNAME       => array(UnitTableMap::COL_UNIT_ID => 0, UnitTableMap::COL_NAME => 1, UnitTableMap::COL_DESCRIPTION => 2, UnitTableMap::COL_UPDATE_TIME => 3, UnitTableMap::COL_UPDATE_USER => 4, ),
        self::TYPE_FIELDNAME     => array('unit_id' => 0, 'name' => 1, 'description' => 2, 'update_time' => 3, 'update_user' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('UnitId', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UnitTableMap::COL_UNIT_ID);
            $criteria->addSelectColumn(UnitTableMap::COL_NAME);
            $criteria->addSelectColumn(UnitTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(UnitTableMap::COL_UPDATE_TIME);
            $criteria->addSelectColumn(UnitTableMap::COL_UPDATE_USER);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(UnitTableMap::COL_UNIT_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(UnitTableMap::COL_UNIT_ID) && $criteria->keyContainsValue(UnitTableMap::COL_UNIT_ID) ) {
