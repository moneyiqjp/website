...
/**
 * This class defines the structure of the 'mailinglist' table.
 *
 *
 *
...
class MailinglistTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.MailinglistTableMap';
     ...
     */
    const TABLE_NAME = 'mailinglist';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Mailinglist';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Mailinglist';
     ...
     */
    const COL_EMAIL = 'mailinglist.email';

    /**
     * the column name for the update_time field
     */
    const COL_UPDATE_TIME = 'mailinglist.update_time';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Email', 'UpdateTime', ),
        self::TYPE_CAMELNAME     => array('email', 'updateTime', ),
        self::TYPE_COLNAME       => array(MailinglistTableMap::COL_EMAIL, MailinglistTableMap::COL_UPDATE_TIME, ),
        self::TYPE_FIELDNAME     => array('email', 'update_time', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Email' => 0, 'UpdateTime' => 1, ),
        self::TYPE_CAMELNAME     => array('email' => 0, 'updateTime' => 1, ),
        self::TYPE_COLNAME       => array(MailinglistTableMap::COL_EMAIL => 0, MailinglistTableMap::COL_UPDATE_TIME => 1, ),
        self::TYPE_FIELDNAME     => array('email' => 0, 'update_time' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MailinglistTableMap::COL_UPDATE_TIME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Mailinglist) { // it's a model object
