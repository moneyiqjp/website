...
class CreditCardTableMap extends TableMap
{
     ...
     */
    const COL_ISSUE_PERIOD = 'credit_card.issue_period';

    /**
     * the column name for the credit_limit_bottom field
     */
    const COL_CREDIT_LIMIT_BOTTOM = 'credit_card.credit_limit_bottom';

    /**
     * the column name for the credit_limit_upper field
     */
    const COL_CREDIT_LIMIT_UPPER = 'credit_card.credit_limit_upper';

    /**
     * the column name for the commission field
     */
    const COL_COMMISSION = 'credit_card.commission';

    /**
     * the column name for the debit_date field
     */
    const COL_DEBIT_DATE = 'credit_card.debit_date';

    /**
     * the column name for the cutoff_date field
     */
    const COL_CUTOFF_DATE = 'credit_card.cutoff_date';

    /**
     * the column name for the isActive field
     */
    const COL_ISACTIVE = 'credit_card.isActive';

    /**
     * the column name for the review_url field
     */
    const COL_REVIEW_URL = 'credit_card.review_url';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('CreditCardId', 'Name', 'IssuerId', 'Description', 'ImageLink', 'Visa', 'Master', 'Jcb', 'Amex', 'Diners', 'AfilliateLink', 'AffiliateId', 'Pointexpirymonths', 'Pointexpirydisplay', 'IssuePeriod', 'CreditLimitBottom', 'CreditLimitUpper', 'Commission', 'DebitDate', 'CutoffDate', 'Isactive', 'ReviewUrl', 'Reference', 'UpdateTime', 'UpdateUser', ),
        self::TYPE_CAMELNAME     => array('creditCardId', 'name', 'issuerId', 'description', 'imageLink', 'visa', 'master', 'jcb', 'amex', 'diners', 'afilliateLink', 'affiliateId', 'pointexpirymonths', 'pointexpirydisplay', 'issuePeriod', 'creditLimitBottom', 'creditLimitUpper', 'commission', 'debitDate', 'cutoffDate', 'isactive', 'reviewUrl', 'reference', 'updateTime', 'updateUser', ),
        self::TYPE_COLNAME       => array(CreditCardTableMap::COL_CREDIT_CARD_ID, CreditCardTableMap::COL_NAME, CreditCardTableMap::COL_ISSUER_ID, CreditCardTableMap::COL_DESCRIPTION, CreditCardTableMap::COL_IMAGE_LINK, CreditCardTableMap::COL_VISA, CreditCardTableMap::COL_MASTER, CreditCardTableMap::COL_JCB, CreditCardTableMap::COL_AMEX, CreditCardTableMap::COL_DINERS, CreditCardTableMap::COL_AFILLIATE_LINK, CreditCardTableMap::COL_AFFILIATE_ID, CreditCardTableMap::COL_POINTEXPIRYMONTHS, CreditCardTableMap::COL_POINTEXPIRYDISPLAY, CreditCardTableMap::COL_ISSUE_PERIOD, CreditCardTableMap::COL_CREDIT_LIMIT_BOTTOM, CreditCardTableMap::COL_CREDIT_LIMIT_UPPER, CreditCardTableMap::COL_COMMISSION, CreditCardTableMap::COL_DEBIT_DATE, CreditCardTableMap::COL_CUTOFF_DATE, CreditCardTableMap::COL_ISACTIVE, CreditCardTableMap::COL_REVIEW_URL, CreditCardTableMap::COL_REFERENCE, CreditCardTableMap::COL_UPDATE_TIME, CreditCardTableMap::COL_UPDATE_USER, ),
        self::TYPE_FIELDNAME     => array('credit_card_id', 'name', 'issuer_id', 'description', 'image_link', 'visa', 'master', 'jcb', 'amex', 'diners', 'afilliate_link', 'affiliate_id', 'pointExpiryMonths', 'pointExpiryDisplay', 'issue_period', 'credit_limit_bottom', 'credit_limit_upper', 'commission', 'debit_date', 'cutoff_date', 'isActive', 'review_url', 'reference', 'update_time', 'update_user', ),
    ...
    public function initialize()
    {
        ...
        $this->addColumn('debit_date', 'DebitDate', 'VARCHAR', false, 250, null);
        $this->addColumn('cutoff_date', 'CutoffDate', 'VARCHAR', false, 250, null);
        $this->addColumn('isActive', 'Isactive', 'TINYINT', false, null, 1);
        $this->addColumn('review_url', 'ReviewUrl', 'VARCHAR', false, 255, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CreditCardTableMap::COL_COMMISSION);
            $criteria->addSelectColumn(CreditCardTableMap::COL_DEBIT_DATE);
            $criteria->addSelectColumn(CreditCardTableMap::COL_CUTOFF_DATE);
            $criteria->addSelectColumn(CreditCardTableMap::COL_ISACTIVE);
            $criteria->addSelectColumn(CreditCardTableMap::COL_REVIEW_URL);
            ...
            $criteria->addSelectColumn($alias . '.debit_date');
            $criteria->addSelectColumn($alias . '.cutoff_date');
            $criteria->addSelectColumn($alias . '.isActive');
            $criteria->addSelectColumn($alias . '.review_url');
