...
class JGeneralRestriction  implements JSONInterface {
    ...
    public function toKeyValueType(){
        $that = array();
        $that['GeneralRestrictionId'] = $this->GeneralRestrictionId;
        $that['Attribute'] = $this->RestrictionType->Name;
        $that['Comparator'] = $this->Comparator;
